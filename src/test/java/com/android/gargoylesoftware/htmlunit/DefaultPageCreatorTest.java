...
public class DefaultPageCreatorTest extends WebServerTestCase {
    ...
    public void determinePageType() {
        assertEquals(DefaultPageCreator.PageType.HTML, DefaultPageCreator.determinePageType("text/html"));

        assertEquals(DefaultPageCreator.PageType.JAVASCRIPT, DefaultPageCreator.determinePageType("text/javascript"));
        assertEquals(DefaultPageCreator.PageType.JAVASCRIPT, DefaultPageCreator.determinePageType("application/x-javascript"));
        assertEquals(DefaultPageCreator.PageType.JAVASCRIPT, DefaultPageCreator.determinePageType("application/javascript"));

        assertEquals(DefaultPageCreator.PageType.XML, DefaultPageCreator.determinePageType("text/xml"));
        assertEquals(DefaultPageCreator.PageType.XML, DefaultPageCreator.determinePageType("application/xml"));
        assertEquals(DefaultPageCreator.PageType.XML, DefaultPageCreator.determinePageType("application/xhtml+xml"));
        assertEquals(DefaultPageCreator.PageType.XML, DefaultPageCreator.determinePageType("text/vnd.wap.wml"));
        assertEquals(DefaultPageCreator.PageType.XML, DefaultPageCreator.determinePageType("application/vnd.mozilla.xul+xml"));
        assertEquals(DefaultPageCreator.PageType.XML, DefaultPageCreator.determinePageType("application/vnd.wap.xhtml+xml"));
        assertEquals(DefaultPageCreator.PageType.XML, DefaultPageCreator.determinePageType("application/rdf+xml"));
        assertEquals(DefaultPageCreator.PageType.XML, DefaultPageCreator.determinePageType("image/svg+xml"));

        assertEquals(DefaultPageCreator.PageType.TEXT, DefaultPageCreator.determinePageType("text/plain"));
        assertEquals(DefaultPageCreator.PageType.TEXT, DefaultPageCreator.determinePageType("text/csv"));
        assertEquals(DefaultPageCreator.PageType.TEXT, DefaultPageCreator.determinePageType("text/css"));
        assertEquals(DefaultPageCreator.PageType.TEXT, DefaultPageCreator.determinePageType("text/xhtml"));

        assertEquals(DefaultPageCreator.PageType.UNKNOWN, DefaultPageCreator.determinePageType(null));
        assertEquals(DefaultPageCreator.PageType.UNKNOWN, DefaultPageCreator.determinePageType(""));
        assertEquals(DefaultPageCreator.PageType.UNKNOWN, DefaultPageCreator.determinePageType(" \t"));
        assertEquals(DefaultPageCreator.PageType.UNKNOWN, DefaultPageCreator.determinePageType("application/pdf"));
        assertEquals(DefaultPageCreator.PageType.UNKNOWN, DefaultPageCreator.determinePageType("application/x-shockwave-flash"));
    }
