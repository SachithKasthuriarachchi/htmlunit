...
public class CookieManagerTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts("a_key=helloA; b_key=helloB; c_key=helloC")
     ...
     */
    @Test
    @BrowserRunner.Alerts("key1=; key2=")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "fourth=4; third=3",
     ...
     */
    @Test
    @BrowserRunner.Alerts("fifth=5; first=1; fourth=4; second=2; sixth=6; third=3")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "first=1; second=2",
            IE = "first=1",
            EDGE = "first=1")
     ...
     */
    @Test
    @BrowserRunner.Alerts("first=1; second=2")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"cookies: first=1", "cookies: "})
