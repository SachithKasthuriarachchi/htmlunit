...
public class HttpWebConnectionTest extends WebServerTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"Host", "User-Agent" }, IE = { })
    public void hostHeaderFirst() throws Exception {
        ...
        final DefaultCredentialsProvider2Test.InMemoryAppender appender = new DefaultCredentialsProvider2Test.InMemoryAppender();
