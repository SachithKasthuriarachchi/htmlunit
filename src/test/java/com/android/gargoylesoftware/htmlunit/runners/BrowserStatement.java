...
class BrowserStatement extends Statement {
    ...
    private void assertAlerts() {
        final BrowserRunner.Alerts alerts = method_.getAnnotation(BrowserRunner.Alerts.class);
        if (alerts != null) {
        ...
        final BrowserRunner.AlertsStandards alerts2 = method_.getAnnotation(BrowserRunner.AlertsStandards.class);
        if (alerts2 != null) {
