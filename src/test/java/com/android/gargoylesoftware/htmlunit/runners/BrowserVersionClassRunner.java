 ...
 */
package com.android.gargoylesoftware.htmlunit.runners;
...
import com.android.gargoylesoftware.htmlunit.WebTestCase;
...
public class BrowserVersionClassRunner extends BlockJUnit4ClassRunner {
    ...
    private void setAlerts(final WebTestCase testCase, final Method method) {
        final BrowserRunner.Alerts alerts = method.getAnnotation(BrowserRunner.Alerts.class);
    ...
    private void setAlertsStandards(final WebTestCase testCase, final Method method) {
        final BrowserRunner.AlertsStandards alerts = method.getAnnotation(BrowserRunner.AlertsStandards.class);
        if (alerts != null) {
            String[] expectedAlerts = {};
            if (isDefined(alerts.value())) {
                expectedAlerts = alerts.value();
     ...
     */
    private boolean isDefinedIn(final BrowserRunner.TestedBrowser[] browsers) {
        for (final BrowserRunner.TestedBrowser browser : browsers) {
            switch (browser) {
                case IE:
    ...
    protected boolean isNotYetImplemented(final FrameworkMethod method) {
        final BrowserRunner.NotYetImplemented notYetImplementedBrowsers = method.getAnnotation(BrowserRunner.NotYetImplemented.class);
    ...
    protected boolean isBuggyWebDriver(final FrameworkMethod method) {
        final BrowserRunner.BuggyWebDriver buggyWebDriver = method.getAnnotation(BrowserRunner.BuggyWebDriver.class);
        return buggyWebDriver != null && isDefinedIn(buggyWebDriver.value());
    }

    private static int getTries(final FrameworkMethod method) {
        final BrowserRunner.Tries tries = method.getAnnotation(BrowserRunner.Tries.class);
