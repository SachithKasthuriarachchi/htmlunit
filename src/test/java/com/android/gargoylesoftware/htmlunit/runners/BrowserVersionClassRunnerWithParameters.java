...
public class BrowserVersionClassRunnerWithParameters extends BrowserVersionClassRunner {
    ...
    protected List<FrameworkMethod> computeTestMethods() {
        ...
        for (final FrameworkMethod m : originalMethod) {
            ...
            if (m.getAnnotation(BrowserParameterizedRunner.Default.class) != null) {
                defualtMethod = m;
        ...
        for (final Iterator<FrameworkMethod> it = methods.iterator(); it.hasNext();) {
            ...
            if (method.getAnnotation(BrowserParameterizedRunner.Default.class) != null && nativeMethodNames.contains(method.getName())) {
                it.remove();
            }
        }
    ...
    protected Description describeChild(final FrameworkMethod method) {
        if (method.getAnnotation(BrowserParameterizedRunner.Default.class) != null) {
