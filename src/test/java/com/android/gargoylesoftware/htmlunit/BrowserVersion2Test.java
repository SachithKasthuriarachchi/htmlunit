...
public class BrowserVersion2Test extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "Accept: text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"2", "Accept: text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(CHROME = "Accept: image/webp,image/apng,image/*,*/*;q=0.8",
            FF = "Accept: */*",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "Accept: text/css,*/*;q=0.1",
            IE = "Accept: text/css, */*",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "Accept: */*",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"2", "Accept: text/css,*/*;q=0.1"},
