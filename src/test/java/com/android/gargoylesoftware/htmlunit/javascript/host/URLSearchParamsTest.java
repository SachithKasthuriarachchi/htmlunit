...
public class URLSearchParamsTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"foo=1&bar=2", ""},
            IE = {})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"key=value", "key=value&empty-key=undefined",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"key2=val2&key2=val3", "", "", "", ""},
            IE = {})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"val1", "val2", "null", "null", "null"},
            IE = {})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"true", "true", "false", "false", "false"},
            IE = {})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"val1,val3", "val2", "", "", ""},
            IE = {})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"key1=val1&key2=val2&key2=val3&key4=val4",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"function keys() { [native code] }", "[object Iterator]",
                    "key1", "key2", "key1", "", "true"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"function values() { [native code] }", "[object Iterator]",
                    "val1", "", "val3", "val4", "true"},
            FF = {"function values() {\n    [native code]\n}", "[object URLSearchParamsIterator]",
                    "val1", "", "val3", "val4", "true"},
            IE = {})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"function entries() { [native code] }", "[object Iterator]",
