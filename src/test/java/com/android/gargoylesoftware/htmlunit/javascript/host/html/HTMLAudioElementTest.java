...
public class HTMLAudioElementTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts(IE = {"[object HTMLAudioElement]", "[object HTMLAudioElement]"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"[object HTMLAudioElement]", "done"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"[object HTMLAudioElement]", "maybe", "done"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "maybe",
            IE = "")
