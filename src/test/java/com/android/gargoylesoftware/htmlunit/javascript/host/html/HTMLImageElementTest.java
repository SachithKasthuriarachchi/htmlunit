...
public class HTMLImageElementTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"[object HTMLImageElement]", "[object HTMLImageElement]"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"[object HTMLImageElement]", "[object HTMLImageElement]", "IMG", "IMG",
     ...
     */
    @Test
    @BrowserRunner.Alerts("§§URL§§foo.gif")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"onLoad", "§§URL§§bar.gif"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"true", "relative", "", ""})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"left", "right", "middle", "justify", "bottom", "middle",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"CenTer", "8", "foo", "left", "right", "middle", "justify",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"number: 300", "number: 200", "number: 0", "number: 0", "number: 0", "number: 0"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"number: 300", "number: 200", "number: 1", "number: 1", "number: 1", "number: 1"})
    ...
    /**
      ...
      */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"number: 300", "number: 200", "number: 24", "number: 24", "number: 24", "number: 24"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"true", "true", "true", "true"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"test", "string", "hui", "", "null", "false", "true", ""})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"myImage clicked", "myImageNone clicked"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "myImageWithMap clicked",
            IE = "a0 clicked")
