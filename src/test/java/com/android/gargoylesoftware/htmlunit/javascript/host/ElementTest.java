...
import com.android.gargoylesoftware.htmlunit.javascript.host.xml.XMLDocumentTest;
...
public class ElementTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"1", "attrName attrValue", "attrValue", "null", "anotherValue",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"lbl_SettingName", "outerHTML", "undefined"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"book", "exception"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"[object HTMLDivElement],DIV",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"[object HTMLDivElement],null",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"[object HTMLDivElement],undefined",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"[object HTMLDivElement],http://www.w3.org/1999/xhtml",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"[object Element]", "dIv",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"[object Element]", "null",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"[object Element]", "undefined",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"prototype found", ""
     ...
     */
    @Test
    @BrowserRunner.Alerts({"first", "third", "3", "second", "second"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"§§URL§§", "§§URL§§"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"[object HTMLCollection] 1", "[object HTMLCollection] 2", "[object HTMLCollection] 0"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"", "a b c"},
            IE = {"undefined", "a b c"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"test value", "true", "false", "finished"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(FF = {"function Element() {\n    [native code]\n}",
            ...
            EDGE = {"function Element() { [native code] }", "[object ElementPrototype]",
                        "function Element() { [native code] }"})
    @BrowserRunner.NotYetImplemented({BrowserRunner.TestedBrowser.FF, BrowserRunner.TestedBrowser.IE, BrowserRunner.TestedBrowser.EDGE})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"function Element() { [native code] }", "[object Element]",
                        "function Element() { [native code] }"},
            FF = {"function Element() {\n    [native code]\n}",
                        "[object ElementPrototype]", "function Element() {\n    [native code]\n}"},
            IE = {"[object Element]", "[object ElementPrototype]", "[object Element]"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"0-0", "0-1", "2-5"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "Philippine eagle",
            IE = "not found")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"SyntaxError", "done"},
            IE = "done")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"TypeError", "done"})
