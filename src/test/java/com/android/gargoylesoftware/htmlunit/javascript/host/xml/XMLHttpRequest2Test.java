...
import com.android.gargoylesoftware.htmlunit.javascript.host.xml.XMLHttpRequestTest.BasicAuthenticationServlet;
...
public class XMLHttpRequest2Test extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"5", "pass", "pass", "pass", "pass"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"1", "bla", "someAttr", "someValue", "true", "foo", "2", "fi1"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "ok",
            IE = "exception")
     ...
     * com.android.gargoylesoftware.htmlunit.xml.XmlPage cannot be cast to com.android.gargoylesoftware.htmlunit.html.HtmlPage
     * @throws Exception if an error occurs
     */
    @Test
     ...
     */
    @Test
    @BrowserRunner.Alerts({"in timeout", "hello"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"hello", "in timeout"})
     ...
     */
    @Test
    @BrowserRunner.Alerts("[object Event]#[object XMLHttpRequest]")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"ok", "4", "<null>"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"ok", "4", "http://localhost:12345"},
            IE = {"ok", "4", "<null>"})
     ...
     */
    @Test
    @BrowserRunner.Alerts("Basic:Zm9vOmJhcg==")
     ...
     */
    @Test
    @BrowserRunner.Alerts("PATCH|some body data")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"<xml><content>blah</content></xml>", "text/xml;charset=utf-8", "gzip", "45"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"null", "null", "null", "null",
     ...
     */
    @Test
    @BrowserRunner.Alerts("exception catched")
     ...
     */
    @Test
    @BrowserRunner.Alerts("exception for onerror")
    @BrowserRunner.NotYetImplemented
