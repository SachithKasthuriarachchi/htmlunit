...
public class ElementClientWidthTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "12",
            FF52 = "18",
            FF60 = "16",
            IE = "20")
    @BrowserRunner.NotYetImplemented
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "300",
            FF = "0",
            IE = "-16")
    @BrowserRunner.NotYetImplemented({BrowserRunner.TestedBrowser.CHROME, BrowserRunner.TestedBrowser.FF})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "159",
            FF = "181",
            IE = "164")
    @BrowserRunner.NotYetImplemented
     ...
     */
    @Test
    @BrowserRunner.Alerts(CHROME = "169",
            FF = "141",
            IE = "143")
     ...
     */
    @Test
    @BrowserRunner.Alerts(CHROME = "253",
            FF52 = "237",
            FF60 = "235",
            IE = "262")
    @BrowserRunner.NotYetImplemented
     ...
     */
    @Test
    @BrowserRunner.Alerts(CHROME = "47",
            FF52 = "50",
            FF60 = "48",
            IE = "100")
    @BrowserRunner.NotYetImplemented
     ...
     */
    @Test
    @BrowserRunner.Alerts(CHROME = "171",
            FF = "141",
            IE = "143")
    @BrowserRunner.NotYetImplemented(BrowserRunner.TestedBrowser.CHROME)
     ...
     */
    @Test
    @BrowserRunner.Alerts(CHROME = "54",
            FF52 = "96",
            FF60 = "94",
            IE = "114")
    @BrowserRunner.NotYetImplemented
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "169",
            FF = "141",
            IE = "143")
