...
public class HashChangeEventTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"[object HashChangeEvent]", "hashchange", "false", "false", "", ""},
            IE = "exception")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"[object HashChangeEvent]", "hashchange", "true", "false", "null", "§§URL§§#1"},
            IE = "exception")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"[object HashChangeEvent]", "", "false", "false", "", ""},
            IE = "exception")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"[object HashChangeEvent]", "[object HashChangeEvent]",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"[object Event]", "hashchange", "true", "false", "undefined", "undefined"})
     ...
     */
    @Test
    @BrowserRunner.Alerts("supported")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"[object HashChangeEvent]", "hashchange", "true", "false", "§§URL§§", "§§URL§§#1"},
