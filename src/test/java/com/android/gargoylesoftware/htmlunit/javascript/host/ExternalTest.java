...
public class ExternalTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"external defined", "no AutoCompleteSaveForm"},
     ...
     */
    @Test
    @BrowserRunner.Alerts("AddSearchProvider defined")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"IsSearchProviderInstalled defined", "IsSearchProviderInstalled: 0"})
    @BrowserRunner.BuggyWebDriver({BrowserRunner.TestedBrowser.IE, BrowserRunner.TestedBrowser.CHROME}) // fail with missing permission
