...
import com.android.gargoylesoftware.htmlunit.javascript.host.event.EventTest;
...
public class Window2Test extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"[object Window]", "exception", "undefined", "undefined", "hello", "hello", "world", "world"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"function", "function"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"not found", "true"},
            FF = {"found", "true"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"SGVsbG8gV29ybGQh", "Hello World!"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"getClass: undefined,undefined", "java: undefined,undefined", "javax: undefined,undefined",
     ...
     */
    @Test
    @BrowserRunner.Alerts("javax.script.filename: undefined")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"original", "changed"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"function Node() {\n    [native code]\n}", "function Element() {\n    [native code]\n}"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"2", "2", "frame1", "frame2"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"0", "0", "2", "2", "2", "true"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"true", "true", "function"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"true", "true", "object"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"[object Window]", "[object Window]", "[object Window]", "1", "true", "true",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"Hello window", ""})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"Hello window", "New window"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"window1", "window2"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"[object Window]", "[object Window] (true)", "1234 (true)", "null (true)", "undefined (true)",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"exception", "exception", "exception", "exception"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(CHROME = {"true", "true", "132", "true", "true", "16"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"true", "1234"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(CHROME = {"636", "1256", "619", "1239"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"0,0", "100,200", "110,230", "0,0", "no scrollByLines()", "0,0", "no scrollByPages()"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"0,0", "0,0", "0,0", "0,0", "no scrollByLines()", "0,0", "no scrollByPages()"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"0", "0", "0", "0"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"undefined", "undefined"},
            FF52 = {"11", "91"},
            FF60 = {"11", "83"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"exception", "exception", "Success"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"true", "I was here"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"null", "function", "null", "null"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"true", "0", "2", "2", "null"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"true", "[object Arguments]", "null", "true", "[object Arguments]", "[object Arguments]"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"true", "[object Arguments]", "null", "true", "[object Arguments]", "null"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"null", "function", "5"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"string string 7 number object", "string string 1 number object"})
     ...
     */
    @Test
    @BrowserRunner.Alerts("rgb(0, 0, 0)")
     ...
     */
    @Test
    @BrowserRunner.Alerts("rgb(255, 0, 0)")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"number", "done", "result"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"number", "done", "42"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"true", "null"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"type: message", "bubbles: false", "cancelable: false", "data: hello",
     ...
     */
    @Test
    @BrowserRunner.Alerts("data: hello")
     ...
     */
    @Test
    @BrowserRunner.Alerts("sync: false")
     ...
     */
    @Test
    @BrowserRunner.Alerts("posted received")
     ...
     */
    @Test
    @BrowserRunner.Alerts("about:blank")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"[object Window]", "[object Window]", ""},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"1", "false", "true", "false", "false"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"false", "false", "test2 alert"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"[object Window]", "[object WindowProperties]", "[object EventTarget]", "[object Object]"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"[object Navigator]", "##test##"},
