...
public class XMLDocument2Test extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"myTarget,myData,7", "myTarget,myData", "<?myTarget myData?>"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"#cdata-section,abcdefghij,4", "abcdefghij", "<![CDATA[abcdefghij]]>"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"#cdata-section,<>&?,4", "<>&?", "<![CDATA[<>&?]]>"},
            IE = {"#cdata-section,<>&?,4", "<>&?", "&lt;&gt;&amp;?"})
     ...
     */
    @Test
    @BrowserRunner.Alerts("createNode not available")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"apache", "foo"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"#comment", "foo"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"name: item1", "id: 1", "id: 2", "name: item2", "name: item3", "id: 3"},
