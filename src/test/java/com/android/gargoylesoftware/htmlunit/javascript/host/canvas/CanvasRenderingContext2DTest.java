...
public class CanvasRenderingContext2DTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"addHitRegion", "drawCustomFocusRing", "drawSystemFocusRing", "removeHitRegion",
     ...
     */
    @Test
    @BrowserRunner.Alerts(CHROME = {"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAAH0lEQVQ4T2NkoBAwUq"
     ...
     */
    @Test
    @BrowserRunner.Alerts({"rendering...", "...done"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(CHROME = "data:image/png;base64,"
     ...
     */
    @Test
    @BrowserRunner.Alerts({"exception", "0", "true", "true"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(CHROME = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAACoAAAAqCAYAAADFw8lbAAABVUl"
     ...
     */
    @Test
    @BrowserRunner.Alerts("[object CanvasGradient]")
