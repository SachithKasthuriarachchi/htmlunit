...
public class HTMLTableSectionElementTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts("<tr><td>world</td></tr>")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"cell1", "[object HTMLTableRowElement]", "abc", "[object Text]", ""})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"undefined", "#0000aa", "x"},
            IE = {"", "#0000aa", "#0"})
