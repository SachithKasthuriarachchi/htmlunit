 ...
 */
package com.android.gargoylesoftware.htmlunit.javascript.host.intl;
...
public class DateTimeFormatTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "12/20/2012",
            IE = "\u200E12\u200E/\u200E20\u200E/\u200E2012")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "\u0662\u0660\u200F\u002f\u0661\u0662\u200F\u002f\u0662\u0660\u0661\u0662",
            IE = "\u200F\u0662\u0660\u200F\u002f\u200F\u0661\u0662\u200F\u002f\u200F\u0662\u0660\u0661\u0662")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "24/12/20",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "20/12/2012",
            IE = "\u200e20\u200e\u002f\u200e12\u200e\u002f\u200e2012")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "Donnerstag, 20. Dezember 2012",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "Donnerstag, 20. Dezember 2012 n. Chr., 04:00:00",
            IE = "\u200EDonnerstag\u200E,"
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "Donnerstag",
            IE = "\u200EDonnerstag")
    @BrowserRunner.NotYetImplemented
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "n. Chr. Donnerstag",
            IE = "\u200EDonnerstag")
    @BrowserRunner.NotYetImplemented
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "20. 12 2012 n. Chr.",
            IE = "\u200E20\u200E.\u200E12\u200E.\u200E2012")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "2012 n. Chr. Donnerstag",
            IE = "\u200EDonnerstag\u200E,"
                + " \u200E20\u200E. \u200EDezember\u200E \u200E2012\u200E \u200E04\u200E:\u200E00\u200E:\u200E00")
    @BrowserRunner.NotYetImplemented
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "Dezember 2012 n. Chr. Donnerstag",
            IE = "\u200EDonnerstag\u200E,"
                + " \u200E20\u200E. \u200EDezember\u200E \u200E2012\u200E \u200E04\u200E:\u200E00\u200E:\u200E00")
    @BrowserRunner.NotYetImplemented
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "\u0627\u0644\u062e\u0645\u064a\u0633\u060c \u0662\u0660 \u062f\u064a\u0633\u0645\u0628\u0631"
                + " \u0662\u0660\u0661\u0662 \u0645\u064a\u0644\u0627\u062f\u064a"
                + " \u0664:\u0660\u0660:\u0660\u0660 \u0635",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "Thursday, December 20, 2012, GMT",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "4:00:00 am GMT+1",
            IE = "\u200E4\u200E:\u200E00\u200E:\u200E00\u200E \u200EAM")
    @BrowserRunner.NotYetImplemented
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "12/20/2012, 04:00:00",
            IE = "\u200e12\u200e\u002f\u200e20\u200e\u002f\u200e2012\u200e\u0020"
                    + "\u200e\u0034\u200e\u003a\u200e00\u200e\u003a\u200e00")
    @BrowserRunner.NotYetImplemented
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "\u0667\u200F/\u0662\u200F/\u0661\u0664\u0663\u0664 \u0647\u0640",
            IE = "\u200F\u0660\u0667\u200F/\u200F\u0660\u0662\u200F/\u200F\u0661\u0664\u0663\u0664")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "2012-12-20",
            FF = "20.12.2012",
            IE = "\u200E20\u200E.\u200E12\u200E.\u200E2012")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "20.12.2012 \u0433.",
            IE = "\u200E20\u200E.\u200E12\u200E.\u200E2012\u200E \u0433.")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "20/12/2555",
            IE = "\u200E20\u200E/\u200E12\u200E/\u200E2555")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "2012\u5E7412\u670820\u65E5",
            IE = "\u200E2012\u200E\u5E74\u200E12\u200E\u6708\u200E20\u200E\u65E5")
