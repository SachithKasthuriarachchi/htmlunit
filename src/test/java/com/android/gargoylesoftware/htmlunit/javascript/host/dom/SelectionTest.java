...
public class SelectionTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"0", "0", "0", "cdefg"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"1:s2/0/s2/1/false/Range/1/xyz[xyz",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"", "null-0", "", "null-0", "", "null-0", "", "null-0"},
