...
public class HTMLDocumentWriteTest extends SimpleWebTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "exception occurred",
            IE = "")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"", "First", "First", "FORM", "true", "true"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"scr1", "scr2"/*, "scr3", "scr4"*/})
