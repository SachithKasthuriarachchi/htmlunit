...
public class NativeArrayTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"1<>5", "5<>2", "1<>2", "5<>1", "2<>1", "1<>1", "5<>9"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"concat: function", "constructor: function", "isArray: undefined", "join: function", "pop: function",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"every: function", "filter: function", "forEach: function", "indexOf: function",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "toSource: undefined",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"hello", "foo", "hello"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(CHROME = "function Array() { [native code] }",
            FF = "function Array() {\n    [native code]\n}",
            IE = "\nfunction Array() {\n    [native code]\n}\n")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"mandarin", "", "mandarin"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"3", "a", "b", "c"},
            IE = "not supported")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"4", "T", "e", "s", "t"},
            IE = "not supported")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"2", "abc", "[object Window]"},
            IE = "not supported")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"3", "1,2", "3,4", "5,6"},
            IE = "not supported")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"1", "by"},
            IE = "not supported")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"TypeError"},
            IE = "not supported")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"1", "abc"},
            IE = "not supported")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"true", "true", "true", "true", "false", "false", "false",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"function", "20"},
            IE = "undefined")
    @BrowserRunner.NotYetImplemented(BrowserRunner.TestedBrowser.IE)
     ...
     */
    @Test
    @BrowserRunner.Alerts({"undefined", "TypeError"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"function", "1"},
            IE = "undefined")
    @BrowserRunner.NotYetImplemented(BrowserRunner.TestedBrowser.IE)
     ...
     */
    @Test
    @BrowserRunner.Alerts({"function", "20,17"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"undefined", "TypeError"},
            FF = {"function", "20,17"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"function", "1,2,3,4"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"function", "false"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"function", "true"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"function", "4", "7"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"function", "30"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"function", "2"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"function", "1,4,9,16"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"function", "16,9,4,1"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"function", "1,16,4,9"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"function", "6", "1,4,9,16,3,7"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"function", "16", "1,4,9"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"function", "6", "3,7,1,4,9,16"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"function", "4,9", "1,16"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"function", "1,4,9,16,1,2", "1,4,9,16"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"function", "4", "1,4,9,16"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"function", "2", "1,4,9,16"})
