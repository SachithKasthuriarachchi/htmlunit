...
public class HTMLOptionElement2Test extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts("SELECT;")
    @BrowserRunner.BuggyWebDriver({BrowserRunner.TestedBrowser.CHROME, BrowserRunner.TestedBrowser.FF60, BrowserRunner.TestedBrowser.IE})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "opt-a; opt-b",
            CHROME = "opt-b")
    @BrowserRunner.BuggyWebDriver
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "onchange-select; onclick-option; onclick-select;",
            IE = "onchange-select; onclick-select;")
    @BrowserRunner.BuggyWebDriver({BrowserRunner.TestedBrowser.CHROME, BrowserRunner.TestedBrowser.FF})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "change-SELECT; click-OPTION; click-OPTION;",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "onchange-select; change-SELECT; onclick-option; click-OPTION; onclick-select; click-OPTION;",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"1", "option1", "0"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"false", "true", "true", "false", "true"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"some text", "some value", "false", "some other text", "some other value", "true"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"o2: text: Option 2, label: Option 2, value: 2, defaultSelected: false, selected: false",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"null", "[object Attr]", "null", "null", "null",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"false null null", "false null null", "true *selected selected",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"[object HTMLOptionsCollection]", "0", "1"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"[object HTMLOptionsCollection]", "0", "exception", "0"},
            IE = {"[object HTMLSelectElement]", "0", "1"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"text1", "New Text1", "", "New Text2", "text3", "New Text3", "text4", "New Text4"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"null", "[object Text]", "null"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"text1", "text1b", "text2"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"text0", "text1", "text1b", "text2"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"o2", "1", "0", "o2"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"o2", "1", "1", "o2"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"value1", "text1", "label1", "value2", "text2", "text2"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"", "", "", "", "text2", "text2", "text2", "label2"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"false-null", "true-selected", "false-null",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"false-null", "true-true", "true-null",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"false-null", "true-true", "false-null",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"o-mouse over [option1]", "s-mouse over [option1]"},
            IE = {})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "o-mouse over [option1]",
