...
public class CSSSelectorTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"li2", "li1", "li2", "li1", "li3", "li1", "2", "li1", "li2"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"1", "li2", "2", "li1", "li3"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"1", "[object HTMLBodyElement]", "1", "0"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"li1", "li4", "li7", "li10"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"1", "something"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"2", "something", "thing2"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"2", "id1", "id2"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"2", "id2", "id3"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"2", "ul2", "ul3"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"li3", "2", "li1", "li3"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"2", "div1", "div3", "2", "div1", "div3", "2", "div1", "div3", "0"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"id2", "span1"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"2", "item_2", "item_3"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"0", "undefined", "1", "[object HTMLInputElement]", "id2"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"5", "cb1", "rd1", "sl1", "ml1", "ml3"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"2", "cb1", "rd1", "2", "cb2", "rd2"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"2", "cb1", "rd1", "2", "cb1", "rd1"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"1", "1-iy", "1-iy", "2", "1-iy", "1-iz"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"2", "id1", "id3"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"1", "id2"},
            CHROME = {"0"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"1", "[object HTMLHtmlElement]"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"first", "second"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"null", "null", "[object HTMLSpanElement]"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"null", "null", "[object HTMLSpanElement]"})
