...
public class MutationObserverTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"exception", "childList", "attributes", "characterData"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"attributes", "ltr"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"attributes", "value", "null", "x", "abc",
     ...
     */
    @Test
    @BrowserRunner.Alerts("[object HTMLHeadingElement]-attributes")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"before", "after div", "after text", "div observed", "text observed"},
