...
public class HTMLElement3Test extends SimpleWebTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"addBehavior not available", "http://localhost:12345/"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "startDownload not available",
            IE = {"Refused", "foo"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"onfocus text1", "onfocus text2", "onfocus text1", "onfocus text2"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"onblur text2", "onblur text1"})
