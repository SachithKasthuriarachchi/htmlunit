...
import com.android.gargoylesoftware.htmlunit.html.Keyboard;
...
public class Event3Test extends SimpleWebTestCase {
     ...
     */
    @Test
    @BrowserRunner.NotYetImplemented // TODO: in IE no click event can be registered for the window
    @BrowserRunner.Alerts({"span bubbling", "div", "div bubbling"})
     ...
     */
    @Test
    @BrowserRunner.Alerts("false") // here not alerts! ;-)
