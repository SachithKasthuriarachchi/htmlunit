...
import com.android.gargoylesoftware.htmlunit.html.HtmlImageInput;
...
public class HTMLInputElementTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"foo", "text", "textfield1", "form1", "cat"})
     ...
     * @throws Exception if the test fails
     */
    @BrowserRunner.Alerts(FF52 = {"error fileupload1", "abc", "abc", "abc", "", "abc", "", "", "abc", "abc",
     ...
     * @throws Exception if the test fails
     */
    @BrowserRunner.Alerts(FF52 = {"error fileupload1", "  ", "  ", "  ", "", "  ", "", "", "  ", "  ",
                        "  ", "  ", "  ", "  ", "  ", "  ", "#000000", "  ", "  ", "  ", "  ", "  ",
                        "  ", "", "50", "  ", "", "  ", ""},
     ...
     * @throws Exception if the test fails
     */
    @BrowserRunner.Alerts(FF52 = {"error fileupload1", "12", "12", "12", "", "12", "", "", "12", "12",
     ...
     */
    @Test
    @BrowserRunner.Alerts(CHROME = {"button", "button", "checkbox", "file", "hidden", "select-one", "select-multiple",
     ...
     * @throws Exception if the test fails
     */
    @BrowserRunner.Alerts(DEFAULT = {"null", "undefined", "null", "[object FileList]", "null", "undefined", "undefined", "null",
     ...
     * @throws Exception if the test fails
     */
    @BrowserRunner.Alerts({"false", "undefined", "false", "false", "false", "undefined", "undefined",
     ...
     * @throws Exception if the test fails
     */
    @BrowserRunner.Alerts(DEFAULT = {"true", "undefined", "true", "true", "true", "undefined", "undefined",
     ...
     * @throws Exception if the test fails
     */
    @BrowserRunner.Alerts({"true", "undefined", "true", "true", "true", "undefined", "undefined",
                "true", "true", "true", "undefined", "true", "undefined", "true",
                "undefined", "true", "true", "true", "true", "true", "true",
                "true", "true", "true", "true", "true", "true", "true"})
    @Test
     ...
     * @throws Exception if the test fails
     */
    @BrowserRunner.Alerts(FF52 = {"abc", "abc", "abc", "", "abc", "foo", "", "abc", "abc",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"false", "true"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"true", "false", "false", "false", "true", "false"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"false", "true", "false", "true", "false", "true"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"radio", "hidden", "image"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"text", "null", "hidden", "hidden"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"text", "null", "text", "text"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"undefined", "30", "undefined", "30", "30", "30", "40", "50", "string", "number"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"undefined", "30", "undefined", "30", "30", "30", "40", "50", "string", "number"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"text TeXt", "password PassWord", "hidden Hidden",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"text text", "text  password", "text hidden ", "text checkbox ", "text \tradio"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"left", "right", "bottom", "middle", "top", "wrong", ""},
            IE = {"", "", "", "", "", "", ""})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"CenTer", "8", "foo", "left", "right", "bottom", "middle", "top"},
            IE = {"", "error", "", "error", "", "", "", "", "", ""})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"", "A", "a", "A", "a8", "8Afoo", "8", "@"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"test", "4", "42", "2", "[object HTMLInputElement]", "25"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "§§URL§§?myName=abcdefg",
            IE = "§§URL§§")
    @BrowserRunner.NotYetImplemented(BrowserRunner.TestedBrowser.IE)
     ...
     */
    @Test
    @BrowserRunner.Alerts("§§URL§§?myName=ab")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"30", "undefined", "30", "30", "40", "50", "string", "string"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"undefined", "undefined", "undefined", "undefined", "undefined", "undefined"},
            CHROME = {"0", "2", "1", "2", "1", "1"},
            FF60 = {"0", "2", "1", "2", "1", "1"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(CHROME = {"169", "17", "169", "17", "13", "13", "13", "13"},
     ...
     */
    @Test
    @BrowserRunner.Alerts("mouse over [tester]")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"Test-Test-Test", "text1-text1-text1"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"Test-Test-Test", "Test-Test-Test"})
