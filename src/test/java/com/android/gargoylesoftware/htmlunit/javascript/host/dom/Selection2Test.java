...
public class Selection2Test extends SimpleWebTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"0", "1"},
            CHROME = {"0", "3"},
            IE = {"0", "exception", "1"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"undefined", "exception", "undefined"},
            FF60 = {"None", "None"},
            CHROME = {"None", "None"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"unsupported action", "unsupported action"})
