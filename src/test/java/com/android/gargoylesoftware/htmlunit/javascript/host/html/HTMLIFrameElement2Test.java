...
public class HTMLIFrameElement2Test extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"loaded", "foo"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"createIFrame", "loaded", "foo"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"createIFrame", "loaded", ""})
     ...
     */
    @Test
    @BrowserRunner.Alerts("createIFrame")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"fragment append done", "loaded"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"createIFrame", "fragment append done", "loaded"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"loaded", "loaded", "loaded"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"about:blank", "§§URL§§"})
