...
public class CSSStyleSheetTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"[object CSSStyleSheet]", "[object HTMLStyleElement]", "true", "undefined", "false"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"4", "0", "1", "2", "3", "length", "item"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"4", "§§URL§§style2.css", "§§URL§§style4.css", "null", "null"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"8", "§§URL§§style1.css 1", "§§URL§§style2.css 0",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"1", "false", "-1", "div", "color: red;", "2"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"2", "-1", "div", "", "3"},
            IE = {"2", "2", "div", "", "3"},
            FF = {"2", "2"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"1", "false", "0", "div", "color: red;", "2"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"1", "false", "0", "div", "", "2"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"2", "false", "false", "undefined", "1", "div", "color: red;"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"2", "1", "div", "color: red;"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"2", "1", "p", "vertical-align: top;"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"2", ".testStyleDef", "height: 42px;", ".testStyle", "width: 24px;"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"false", "false", "true", "true", "false"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"false", "false", "true", "false", "true"},
            CHROME = {"false", "false", "false", "false", "false"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"false", "false", "true", "false", "true", "true", "true", "true"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"false", "false", "false", "false", "true", "false", "true", "false"},
            CHROME = {"false", "false", "false", "false", "false", "false", "false", "false"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"false", "false", "true", "false", "false", "false", "true", "true"},
            CHROME = {"false", "false", "false", "false", "false", "false", "false", "false"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"false", "false", "false", "true", "true", "true", "false", "false"},
            CHROME = {"false", "false", "false", "false", "false", "false", "false", "false"})
     ...
     */
    @Test
    @BrowserRunner.Alerts("width=100")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "60",
            CHROME = "auto")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"10", "10"},
            CHROME = {"auto", "auto"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"block", "1"},
            CHROME = {"block", "0"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"none", "1"},
            IE = {"block", "1"})
    @BrowserRunner.NotYetImplemented(BrowserRunner.TestedBrowser.IE)
