...
public class NavigatorTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"string", "20100101"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "Shockwave Flash not available",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"number", "number"})
     ...
     */
    @Test
    @BrowserRunner.Alerts("[object Geolocation]")
     ...
     */
    @Test
    @BrowserRunner.Alerts(CHROME = {"Google Inc.", ""},
            FF = {"", ""},
            IE = {"", "undefined"},
            EDGE = {"", ""})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"undefined", "undefined", "undefined"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"unspecified", "undefined", "undefined"},
