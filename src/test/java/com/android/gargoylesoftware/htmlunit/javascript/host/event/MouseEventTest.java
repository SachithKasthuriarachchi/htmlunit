...
public class MouseEventTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"DOM2: [object MouseEvent]", "DOM3: [object MouseEvent]"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"click", "true", "true", "true", "1", "2", "3", "4", "true", "true", "true", "true"})
     ...
     */
    @Test
    @BrowserRunner.Alerts("Click on DIV(id=div1): true, true, false, false")
     ...
     */
    @Test
    @BrowserRunner.Alerts("Click on SPAN(id=span1): true, true, true, false")
     ...
     */
    @Test
    @BrowserRunner.Alerts("Click on SPAN(id=span2): true, false, false, true")
     ...
     */
    @Test
    @BrowserRunner.Alerts("Click on TEXTAREA(id=myTextarea): true, false, false, false")
