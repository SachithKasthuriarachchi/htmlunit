...
import com.android.gargoylesoftware.htmlunit.javascript.MockActiveXObject;
...
public class HTMLObjectElementTest extends SimpleWebTestCase {
    ...
    public void classid() throws Exception {
        ...
        activeXObjectMap.put(clsid, "com.android.gargoylesoftware.htmlunit.javascript.MockActiveXObject");
     ...
     */
    @Test
    @BrowserRunner.Alerts(IE = {"Javascript called this method!", "ActiveX is still alive"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"undefined", "string", "test"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"undefined", "function", "test"})
