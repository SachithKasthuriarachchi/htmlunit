...
public class History2Test extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"[object PopStateEvent]", "null"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"[object PopStateEvent]", "{\"hi\":\"there\"}",
     ...
     */
    @Test
    @BrowserRunner.Alerts(CHROME = {"[object PopStateEvent]", "{\"hi\":\"there\"}", "false",
     ...
     */
    @Test
    @BrowserRunner.Alerts(CHROME = {"[object PopStateEvent]", "null", "true",
                        "[object PopStateEvent]", "null", "true",
                        "[object PopStateEvent]", "{\"hi2\":\"there2\"}", "false",
                        "[object PopStateEvent]", "{\"hi2\":\"there2\"}", "false"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"false", "false", "false", "false", "false", "false"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"back", "forward", "go", "length", "pushState", "replaceState",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"auto", "manual", "auto", "auto", "auto", "auto"},
