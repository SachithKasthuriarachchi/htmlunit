...
public class SVGTextPathElementTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "[object SVGTextPathElement]",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"[object SVGTextPathElement]", "true"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"[object SVGTextPathElement]", "43.3"},
