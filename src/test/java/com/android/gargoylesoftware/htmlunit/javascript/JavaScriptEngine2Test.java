...
public class JavaScriptEngine2Test extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"true", "false", "false", "true"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"in goo", "in hoo", "in foo"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"undefined", "function foo() {}"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"[object Window]", "[object Window]", "true",
     ...
     */
    @Test
    @BrowserRunner.Alerts("function f() {}")
    @BrowserRunner.NotYetImplemented
     ...
     */
    @Test
    @BrowserRunner.Alerts("that's it")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"0", "false", "0"},
            IE = {"1", "true", "1"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"rstlne-rstlne-rstlne", "rstlno-rstlne-rstlne",
     ...
     */
    @Test
    @BrowserRunner.Alerts("[object Window]")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"t=undefined", "inside"})
