 ...
 */
package com.android.gargoylesoftware.htmlunit.javascript.host.file;
...
import com.android.gargoylesoftware.htmlunit.annotations.BuildServerDiscrepancy;
...
public class FileReaderTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts("data:text/plain;base64,SHRtbFVuaXQ=")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "data:;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABAQMAAAAl21bKAAAABlBMVEX+1K8AAADjghFsAAAAGXRFWHRTb2"
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "data:",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"[object ArrayBuffer]", "8"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"[object ArrayBuffer]", "128"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"[object ArrayBuffer]", "0"})
