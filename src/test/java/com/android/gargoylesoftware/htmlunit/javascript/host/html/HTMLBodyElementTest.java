...
public class HTMLBodyElementTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"0px,0px,0px,0px,0px", ",,,,", "8px,8px,8px,8px,8px", ",,,,"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"", "http://www.foo.com/blah.gif", "blah.gif"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"[object HTMLBodyElement]", ""},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"keydown (target)", "keydown (body)"})
