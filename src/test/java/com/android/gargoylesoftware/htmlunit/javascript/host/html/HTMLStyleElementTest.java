...
public class HTMLStyleElementTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"[object HTMLStyleElement]", "[object CSSStyleSheet]", "undefined"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({".a > .t { }", ".b > .t { }", ".c > .t { }"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"", "text/test", "text/css"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"", "all", "screen, print,test"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"all", "", "screen:screen", "priNT", "screen, print"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"undefined", "true", "false"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"rgb(0, 128, 0)", "false", "rgb(0, 0, 0)"})
