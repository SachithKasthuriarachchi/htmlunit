...
public class EnumeratorTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "Enumerator not supported",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"f t1 t2", "Enumerator not supported"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"undefined", "Enumerator not supported"},
