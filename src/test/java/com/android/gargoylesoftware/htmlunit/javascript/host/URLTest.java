...
public class URLTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = { "https://developer.mozilla.org/", "https://developer.mozilla.org/",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "http://developer.mozilla.org",
            IE = {})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"", "a=u&x="},
            IE = {})
