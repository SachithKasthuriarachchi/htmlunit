...
public class TreeWalkerTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"BODY", "BODY", "1", "undefined"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"A", "A", "4294967295", "undefined"},
            IE = {"A", "A", "-1", "true"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"BODY", "DIV", "1", "undefined"},
            IE = {"BODY", "DIV", "1", "true"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"BODY", "SPAN", "1", "undefined"},
            IE = {"BODY", "SPAN", "1", "true"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"BODY", "P", "1", "undefined"},
            IE = {"BODY", "P", "1", "true"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"BODY", "BODY", "1", "undefined", "null"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"BODY", "P", "1", "undefined", "null"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"BODY", "DIV", "1", "undefined", "null"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"BODY", "DIV", "SPAN", "A", "P", "undefined", "P"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"P", "A", "SPAN", "DIV", "BODY", "undefined", "BODY"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"DIV", "SPAN", "A", "undefined", "P", "BODY", "undefined", "SPAN", "undefined",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"TITLE", "SCRIPT", "HEAD", "HTML", "HEAD", "BODY", "undefined"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"TITLE", "undefined", "HEAD", "HTML", "HEAD", "BODY", "undefined"},
            IE = "exception")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"TITLE", "undefined", "HEAD", "HTML", "HEAD", "BODY", "undefined"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"P", "undefined"},
            IE = "exception")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"A", "P", "CODE", "PRE", "undefined"},
            IE = "exception")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"PRE", "CODE", "P", "A", "undefined"},
            IE = "exception")
