...
public class Location2Test extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"", "about:blank", "blank", "", "about:", ""},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"#a%20b", "§§URL§§#a%20b", "#a%20b", "§§URL§§#a%20b", "#abc;,/?:@&=+$-_.!~*()ABC123foo",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"#myDataTable=foo%3Dojkoj", "§§URL§§#myDataTable=foo%3Dojkoj"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"#%C3%BC%C3%B6%C3%A4", "§§URL§§#%C3%BC%C3%B6%C3%A4"},
            IE = {"#üöä", "§§URL§§#üöä"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "#%3Ca%3Efoobar%3C/a%3E",
            IE = "#<a>foobar</a>")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"", "foo3.html", "foo2.html"},
            CHROME = {"", "foo2.html"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"", "foo3.html"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"supported", "onhashchange http://localhost:12345/#1  http://localhost:12345/"},
     ...
     */
    @Test
    @BrowserRunner.Alerts("onhashchange #/foo")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"supported", "onhashchange §§URL§§#1  §§URL§§"},
            IE = {"supported", "onhashchange undefined  undefined"})
     ...
     */
    @Test
    @BrowserRunner.Alerts("§§URL§§menu.html")
     ...
     */
    @Test
    @BrowserRunner.BuggyWebDriver(BrowserRunner.TestedBrowser.FF)
