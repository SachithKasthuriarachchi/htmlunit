...
public class DotTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts("this is a test")
     ...
     */
    @Test
    @BrowserRunner.Alerts("abcdefghijklmnopqrstuvwxyz")
     ...
     */
    @Test
    @BrowserRunner.Alerts("`1234567890-=~!@#$%^&*()_+")
