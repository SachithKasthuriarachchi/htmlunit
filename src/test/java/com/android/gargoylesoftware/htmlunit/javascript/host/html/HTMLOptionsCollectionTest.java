...
public class HTMLOptionsCollectionTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"3", "4", "One", "Two*", "Three", "foo"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"3", "4", "foo", "One", "Two*", "Three"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"3", "4", "One", "foo", "Two*", "Three"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"3", "4", "One", "Two*", "foo", "Three"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"3", "3", "One", "Two*", "Three"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"3", "3", "foo", "Two*", "Three"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"3", "3", "One*", "foo", "Three"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"3", "3", "One", "Two*", "foo"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"3", "11", "One", "Two*", "Three", "", "", "", "", "", "", "", "foo"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"2", "Two*", "Three"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"2", "Two*", "Three"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"2", "One*", "Three"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"2", "One", "Two*"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"3", "One", "Two*", "Three"},
            FF = {"2", "Two*", "Three"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"0", "1", "One", "3", "One", "Two", "Three"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"1", "", "1", "One", "1", "One"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"2", "", "", "2", "One", "", "2", "One", "Two"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"3", "", "", "", "3", "One", "", "", "3", "One", "Two", "Three"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"1", "", "4", "One", "1", "", "0"},
            FF = {"1", "", "4", "One", "1", "", "1"})
