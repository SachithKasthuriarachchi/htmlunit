...
public class UIEventTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"DOM2: [object UIEvent]", "DOM3: [object UIEvent]"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"[object UIEvent]", "click", "true", "true", "true", "7"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"[object Event]", "undefined", "[object MouseEvent]", "1", "[object MouseEvent]", "2"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"[object Event]", "undefined", "[object MouseEvent]", "[object Window]"},
