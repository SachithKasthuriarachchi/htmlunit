...
public class EventTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"[object Event]", "event", "false", "false"},
            IE = "exception")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"[object Event]", "event", "true", "false"},
            IE = "exception")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"[object Event]", "", "false", "false"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"DOM2: [object Event]", "DOM3: [object Event]", "vendor: [object Event]"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"[object Event]", "event", "true", "false"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"[object HTMLInputElement]", "true"},
            FF = {"undefined", "false"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"[object Window]", "[object HTMLDivElement]"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"123a4a", "1a2a3ab4ab1ab2ab3abc4abc"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "frame1",
            CHROME = {})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "called",
            CHROME = {})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"inline", "null"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"[object Event]", "load", "false", "false"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"[object Event]", "number"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"click", "true", "true", "click", "false", "false"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"dblclick", "true", "true", "dblclick", "false", "false"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"unknown", "true", "true", "unknown", "false", "false"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"cASe", "true", "true", "cASe", "false", "false"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"e-0", "e-1", "e-2", "e-3", "e-4", "e-5",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"form1 -> custom", "form2 -> [object HTMLFormElement]",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"activeElement BODY"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"focus INPUT", "focus INPUT"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "blur INPUT",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"2from window", "1from document"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"from theField", "from theForm", "from document", "from window"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"from theField", "from document", "from document", "from window"})
     ...
     */
    @Test
    @BrowserRunner.Alerts("from document")
