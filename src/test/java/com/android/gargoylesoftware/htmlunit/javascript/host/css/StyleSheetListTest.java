...
public class StyleSheetListTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"rgb(255, 0, 0)", "rgb(255, 0, 0)"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"0", "undefined", "undefined", "undefined"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"1", "[object CSSStyleSheet]", "[object CSSStyleSheet]"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"1", "2"},
            CHROME = {"1", "1"})
