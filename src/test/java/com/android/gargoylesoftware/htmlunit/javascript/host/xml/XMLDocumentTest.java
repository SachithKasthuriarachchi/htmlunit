...
public class XMLDocumentTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"book", "exception /title", "exception title"})
     ...
     */
    @Test
    @BrowserRunner.Alerts("someprefix:test")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "http://myNS",
            IE = {})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "button",
            IE = {})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"same doc: false", "in first: 3", "book", "ownerDocument: doc1",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"0", "1", "0", "1"},
            IE = {"1", "0"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"false", "false", "true", "false"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"true", "true"},
            IE = {"false", "false"})
    // XML ID handling not yet correctly implemented
     ...
     */
    @Test
    @BrowserRunner.Alerts("nodeFromID not available")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"[object XMLDocument]", "OK"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "[object HTMLDocument]",
            IE = "[object Document]")
    @BrowserRunner.NotYetImplemented(BrowserRunner.TestedBrowser.IE)
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "[object XMLDocument]",
            IE = "[object Document]")
