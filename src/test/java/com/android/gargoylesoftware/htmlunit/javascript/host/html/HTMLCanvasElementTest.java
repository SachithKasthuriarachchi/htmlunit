...
public class HTMLCanvasElementTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"300", "number", "150", "number", "[object CanvasRenderingContext2D]"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(FF = {"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAASwAAACWCAYAAABkW7XSAAAAxUlEQVR4nO3BMQEAAADCoPVPbQhf"
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"[object CanvasRenderingContext2D]", "[object WebGLRenderingContext]",
                        "[object WebGLRenderingContext]", "[object WebGL2RenderingContext]", "null", "null"},
            FF60 = {"[object CanvasRenderingContext2D]", "[object WebGLRenderingContext]",
     ...
     */
    @Test
    @BrowserRunner.Alerts("[object CanvasRenderingContext2D]")
