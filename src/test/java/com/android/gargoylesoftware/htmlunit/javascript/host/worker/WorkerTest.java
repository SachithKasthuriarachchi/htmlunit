...
public class WorkerTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts("Received:worker loaded")
     ...
     */
    @Test
    @BrowserRunner.Alerts("Received: Result = 15")
     ...
     */
    @Test
    @BrowserRunner.Alerts("start worker in imported script1 in imported script2 end worker")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "[object DedicatedWorkerGlobalScope] [object DedicatedWorkerGlobalScope] true",
