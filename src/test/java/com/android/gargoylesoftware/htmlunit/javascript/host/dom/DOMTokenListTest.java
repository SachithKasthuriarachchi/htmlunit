...
public class DOMTokenListTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"3", "b", "b", "true", "false", "c d"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"0", "null", "false", "# removed", ""})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"0", "undefined", "1", "#"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"3", "0", "3", "8"},
            CHROME = {"3", "0", "2", "8"},
            FF60 = {"3", "0", "2", "8"},
            IE = {"3", "0", "3", "7"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"a", "b", "c", "d", "\u000B", "e", "f", "g", "null", "null", "null"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"a b", "2", "null", "undefined"},
            IE = {"a b", "2", "null", "null"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"a b", "2", "a", "a"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"a b", "2", "b", "b"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"a b", "2", "false"},
            IE = {"a b", "2", "exception"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"a b", "2", "true"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"abc def", "2", "false"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"abcd ef", "2", "false"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"a b", "2", "exception", "2", "a b"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"a b", "2", "3", "a b \u000B"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"a  ", "1", "2", "a b"},
            FF52 = {"a  ", "1", "2", "a  b"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"a b", "2", "3", "a b c"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"a b", "2", "2", "a b"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"b a", "2", "2", "b a"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"a b a", "3", "exception", "3", "a b a"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"a b a\tb", "4", "exception", "4", "a b a\tb"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"a \t c \n d  e", "4", "4", "a \t c \n d  e"},
            CHROME = {"a \t c \n d  e", "4", "4", "a c d e"},
            FF60 = {"a \t c \n d  e", "4", "4", "a c d e"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"2", "3"},
            IE = "no list")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"a b", "2", "2", "a b"},
            IE = {"a b", "2", "exception", "2", "a b"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"a b a", "3", "1", "b"},
            CHROME = {"a b a", "2", "1", "b"},
            FF60 = {"a b a", "2", "1", "b"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"exception", "exception", "2", "true", "false", "1", "false", "true", "2", "true"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"2", "false", "true", "false", "false"},
