...
public class Console2Test extends SimpleWebTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts("info: [\"one\", \"two\", \"three\", ({})]")
     ...
     */
    @Test
    @BrowserRunner.Alerts("info: string: HtmlUnit; numb: 4, 4; float: 4.2, link: http://htmlunit.sourceforge.net/")
     ...
     */
    @Test
    @BrowserRunner.Alerts("info: string: %s; %i;")
     ...
     */
    @Test
    @BrowserRunner.Alerts("info: string: #; %i; %i;")
     ...
     */
    @Test
    @BrowserRunner.Alerts("info: string: param1; param2")
     ...
     */
    @Test
    @BrowserRunner.Alerts("info: %i; 1; %i; % 2.0 3.0 4.0")
     ...
     */
    @Test
    @BrowserRunner.Alerts("info: 12%i3; 4.0")
     ...
     */
    @Test
    @BrowserRunner.Alerts("info: %x 1 10%  % ; 2.0")
     ...
     */
    @Test
    @BrowserRunner.Alerts("info: $Version$")
