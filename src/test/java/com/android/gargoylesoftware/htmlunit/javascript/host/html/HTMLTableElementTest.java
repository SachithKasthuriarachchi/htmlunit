...
public class HTMLTableElementTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"caption1", "caption2", "null", "caption3", "exception",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"thead1", "thead2", "null", "thead3", "exception",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"2", "true", "4 2 2", "6 3 3"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"2", "true", "3", "2", "3", "2"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"2", "true", "8 2 2 2 2",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"tfoot1", "tfoot2", "null", "tfoot3", "exception",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"0", "1", "0", "1", "-1"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"2", "exception"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"mytable", "mytable"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"TBODY", "TABLE"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"TBODY", "TBODY", "TBODY"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"table: [object HTMLTableElement]",
     ...
     */
    @Test
    @BrowserRunner.Alerts("no refresh function")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"", "hello", "left", "hi", "right"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"", "#0000aa", "x"},
            IE = {"", "#0000aa", "#0"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"cell1", "[object Text]", "abc", "[object Text]", ""})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"undefined", "#667788", "unknown", "undefined", "undefined", "undefined"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"", "hello", "unknown", "exception", "", "test"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"none", "groups", "rows", "cols", "wrong", ""},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"groUPs", "8", "foo", "rows", "cols"},
