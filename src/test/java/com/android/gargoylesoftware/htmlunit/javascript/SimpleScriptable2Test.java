...
public class SimpleScriptable2Test extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"x1", "x2", "x3", "x4", "x5"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"true", "function", "function"})
     ...
     */
    @Test
    @BrowserRunner.Alerts("window.length was set")
     ...
     */
    @Test
    @BrowserRunner.Alerts("document.getElementById was set")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"function", "true", "function get length() {\n    [native code]\n}", "0", "0"},
