 ...
 */
package com.android.gargoylesoftware.htmlunit.javascript.regexp;
...
public class HtmlUnitRegExpProxyTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts("<script>boo();</script>")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"true", "false", "true"})
     ...
     */
    @Test
    @BrowserRunner.Alerts("{#abcd},{,abcd,}")
     ...
     */
    @Test
    @BrowserRunner.Alerts({":toto,toto,,", "null"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({ "[floating=true],floating,=,,true",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"axxxxa,a", "xxxx,", "xxxx,", "xxxx,"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"abcx\u0004,b,x", "null", "null", "null"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"abcx,b,x", "abcx,b,x", "null", "null"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"null", "abb,a,b", "abd,a,b"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "afood$0$7b",
            IE = "afoodfoo$7b")
     ...
     */
    @Test
    @BrowserRunner.Alerts("I$want$these$periods$to$be$$s")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "ad$0db",
            IE = "adfoodb")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "ad$0dbfuoc",
            IE = "adfoodbfuoc")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "ad$0dbd$0dc",
            IE = "adfoodbdfuodc")
     ...
     */
    @Test
    @BrowserRunner.Alerts("kid\\'s toys")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"\\*\\[", "\\\\", "+1", "abcdef", "1\\1abc123\\123de1234\\1234f", "\n  \n", "x  x", "x\"\\", "$$x$"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"foobar", "$0bar", "$1bar", "\\$1bar", "\\1", "cb", "cb", "a$$b", "a$1b", "a$`b", "a$'b"})
     ...
     */
    @Test
    @BrowserRunner.Alerts("part1:part2")
     ...
     */
    @Test
    @BrowserRunner.Alerts("\\[ab\\]\\(xy\\)\\{z\\} \\{\\[\\(o\\}\\]\\)")
     ...
     */
    @Test(timeout = 1000)
    @BrowserRunner.Alerts({"2200915", "2000915"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"true", "true", "true", "true", "true", "true", "true"})
     ...
     */
    @Test
    @BrowserRunner.Alerts("xaxbxxcx*xdx")
