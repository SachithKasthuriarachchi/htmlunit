...
public class MessageEventTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"-[object MessageEvent]", "-type-message", "-false", "-false", "-null", "-", "-", "-null"},
            IE = "exception")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"-[object MessageEvent]", "-type-message", "-false", "-false",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"DOM2: exception", "DOM3: [object MessageEvent]"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"-[object MessageEvent]", "-message", "-true", "-true", "-hello",
