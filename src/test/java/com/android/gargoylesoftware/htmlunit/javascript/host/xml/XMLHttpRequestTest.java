...
public class XMLHttpRequestTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts("[object XMLHttpRequest]")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"1: 0-", "2: ", "3: 200-OK"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"1: 0-", "2: 0-", "#1: 0-", "3: 0-", "4: 0-", "#2: 200-OK", "#3: 200-OK", "#4: 200-OK"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"orsc1", "open-done", "send-done",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"1", "someAttr", "undefined", "undefined"})
     ...
     */
    @Test
    @BrowserRunner.Alerts("received: null")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"true", "exception"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "40644",
            CHROME = {"233", "187", "8222"},
            IE = {})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"ibcdefg", "xxxxxfg"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "ActiveXObject not available",
            IE = {"0", "0"})
     ...
     */
    @Test
    @BrowserRunner.Alerts("selectNodes not available")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"[object Element]", "myID", "blah", "span", "[object XMLDocument]"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"[object Element]", "[object Element]", "[object HTMLBodyElement]",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"0", "undefined"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"39", "27035", "65533", "39"},
            IE = {"39", "27035", "63"})
     ...
     */
    @Test
    @BrowserRunner.Alerts("[object ProgressEvent]")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"someLoad [object ProgressEvent]", "load", "false"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"someLoad [object ProgressEvent]", "load", "false", "11", "0"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "[object XMLHttpRequestUpload]",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"0", "1", "2", "3", "4"},
            IE = {"0", "1", "1", "2", "3", "4"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(FF = {"[object Object]", "undefined", "undefined",
     ...
     */
    @Test
    @BrowserRunner.Alerts(FF52 = {"[object Object]", "undefined", "undefined",
                        "function () { return !0 }",
                        "function set onreadystatechange() {\n    [native code]\n}",
                        "true", "true"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "[object XMLHttpRequestPrototype]",
