...
public class HTMLFormElementTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"16", "button1", "button2", "checkbox1", "fileupload1", "hidden1",
            "radio1", "radio1",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"undefined", "undefined"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"http://foo.com/", "mailto:me@bar.com", "mailto:me@bar.com"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"myForm", "testForm", "testForm"})
     ...
     */
    @Test
    @BrowserRunner.Alerts("application/x-www-form-urlencoded")
     ...
     */
    @Test
    @BrowserRunner.Alerts("multipart/form-data")
     ...
     */
    @Test
    @BrowserRunner.Alerts("text/plain")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"multipart/form-data", "application/x-www-form-urlencoded", "application/x-www-form-urlencoded"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"text/plain", "application/x-www-form-urlencoded", "newEncoding"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"application/x-www-form-urlencoded", "application/x-www-form-urlencoded", "newEncoding"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"get", "post", "post"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"_top", "_parent", "_parent"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"action2", "foo"})
    ...
    */
     ...
     */
    @Test
    @BrowserRunner.Alerts("§§URL§§foo.html")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"INPUT", "idImg1", "img2", "true"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"page 1: formPage1", "page 2: formPage2"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"function handler() {}", "null", "null"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"page1.html", "page2.html", "page1.html", "page1.html"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"page4.html?f1=v1&f2=v2", "page4.html?f1=v1&f2=v2", "page3.html?f1=v1", "page3.html?f1=v1"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "2",
            IE = "3")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"", "foo4?foo=", "script4.js"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"[object HTMLInputElement]", "undefined",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"[object HTMLInputElement]", "[object HTMLInputElement]"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "in listener",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"srcElement null: false", "srcElement==form: true",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"prepare frame", "submit form", "submitted ok"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"submit form", "listener: submitted ok"})
