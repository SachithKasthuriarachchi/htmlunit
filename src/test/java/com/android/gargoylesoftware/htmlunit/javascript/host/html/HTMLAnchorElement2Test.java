...
public class HTMLAnchorElement2Test extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"", "", "", "§§URL§§test.css", "stylesheet", "stylesheet1"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"attachEvent not available", "href"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"", "§§URL§§foo.html", "javascript:void(0)", "§§URL§§#", "mailto:"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"§§URL§§testsite1.html", "testsite1.html", "§§URL§§testsite2.html",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"http://htmlunit.sourceforge.net/", "§§URL§§test", "§§URL§§#test",
        "§§URL§§#", "§§URL§§"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"http://htmlunit.sourceforge.net/", "§§URL§§test", "§§URL§§index.html#test",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"true", "not defined"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"9", "9", "true", "false"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"# inner", "main"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"1", "inner", "# "},
            CHROME = {"0", "# inner", "main"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"inner", "# main"},
            CHROME = {"# inner", "main"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(IE = {"§§URL§§second/", "object", "[object HTMLAnchorElement]"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"", "", "text/html", "TExT/hTMl", " text/html ", "application/pdf", "unknown"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"text/html", "", " TExT/hTMl  ", "unknown", "application/pdf"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"http:||||||/", "https:||||||/", "mailto:||||||", "tel:||||||",
                        "foo:||||||", "p:||||||", "p:||||||", "p:||||||"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"", "0,0"},
            IE = {"", "0,0,0,0"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"", "§§URL§§", "§§URL§§", "§§URL§§", "http://www.htmlunit.org",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"-null", "-", "-  \t ", "no-referrer-no-referrer",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"origin-origin", "-unknown", "no-referrer-no-referrer",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"[object HTMLButtonElement]", "[object HTMLButtonElement]",
