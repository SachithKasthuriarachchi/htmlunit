...
public class HTMLFrameElement2Test extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"frame=OK", "frames.length=2", "frame=OK", "frames.length=0", "frame=OK", "frames.length=0"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"§§URL§§subdir/frame.html", "§§URL§§frame.html"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"about:blank", "oFrame.foo: undefined", "/frame1.html", "oFrame.foo: foo of frame 1",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "[object HTMLFrameElement]",
            IE = "[object Window]")
     ...
     */
    @Test
    @BrowserRunner.Alerts("OnloadTest head bottom frameset")
     ...
     */
    @Test
    @BrowserRunner.Alerts("OnloadTest left right frameset")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"OnloadTest", "header -> content -> frameSet",
