...
public class PromiseTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"function", "function", "undefined", "undefined",
     ...
     */
    @Test
    @BrowserRunner.Alerts(CHROME = { "function () { [native code] }",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"done", "Rejected"},
            IE = {})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"done", "false", "[object Promise]"},
            IE = {})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"done", "Resolved"},
            IE = {})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"done", "undefined"},
            IE = {})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"done", "1"},
            IE = {})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"done", "HtmlUnit"},
            IE = {})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"done", "true", "42"},
            IE = {})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"true", "fulfilled!", "TypeError: Throwing 1", "Resolving"},
            IE = "")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"done", "1", "2"},
            IE = {})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"done", "1 yes", "2 yes"},
            IE = {})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"done", "first", "second"},
            IE = {})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"done", "Success first"},
            IE = {})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"done", "Failure first"},
            IE = {})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"Success", "string", "oh, no!", "after catch"},
            IE = {})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"done", "Success"},
            IE = "")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"done", "object", "3", "3,1337,Success"},
            IE = {})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"done", "first 3,1337,Success", "second 3,Success"},
            IE = {})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"done", "string", "Failed"},
            IE = {})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"done", "first Failed", "second Failed"},
            IE = {})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"done", "Success 2"},
            IE = {})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"done", "first Success 2", "second Success 2"},
            IE = {})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"done", "Failed"},
            IE = {})
