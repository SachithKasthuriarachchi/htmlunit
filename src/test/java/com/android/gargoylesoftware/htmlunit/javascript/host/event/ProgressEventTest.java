...
public class ProgressEventTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"[object ProgressEvent]", "progress", "false", "false", "false", "0", "0"},
            IE = "exception")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"[object ProgressEvent]", "test", "true", "false", "true", "234", "666"},
            IE = "exception")
