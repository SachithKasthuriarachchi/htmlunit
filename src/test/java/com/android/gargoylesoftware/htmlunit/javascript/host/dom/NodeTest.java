...
import static com.android.gargoylesoftware.htmlunit.javascript.host.xml.XMLDocumentTest.LOAD_XML_DOCUMENT_FROM_STRING_FUNCTION;
import static com.android.gargoylesoftware.htmlunit.javascript.host.xml.XMLDocumentTest.SERIALIZE_XML_DOCUMENT_TO_STRING_FUNCTION;
import static com.android.gargoylesoftware.htmlunit.javascript.host.xml.XMLDocumentTest.callLoadXMLDocumentFromString;
import static com.android.gargoylesoftware.htmlunit.javascript.host.xml.XMLDocumentTest.callSerializeXMLDocumentToString;
...
public class NodeTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"[object HTMLSpanElement]", "[object Text]", "null"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"4", "function", "3"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"2", "SPAN", "2", "#text", "H1", "H2"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"nb nodes: 2", "8", "1"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"document: 9", "document.body: 1", "body child 1: 3", "body child 2: 8"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"1", "exception", "1", "exception", "1", "exception", "1"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"3", "3", "3", "3", "3", "3", "3", "3"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"<div id=\"myDiv2\"></div><div id=\"myDiv3\"></div>", "myDiv2",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"1", "1", "2", "4", "8", "16", "32"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"0", "20", "20", "4", "10", "10", "2", "20", "exception"})
     ...
     */
    @Test
    @BrowserRunner.Alerts("<root><![CDATA[abc]]><![CDATA[def]]></root>")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"4", "3", "abc", "def", "123456", "true", "0", "2", "123", "456", "1", "true"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"[object Element]", "[object HTMLHtmlElement]"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"hi", "undefined", "abcd", "undefined"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "<div><span></span>nullundefinedhello<p></p></div>",
            IE = "<div><p></p></div>")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "<div><p></p><span></span>nullundefinedhello</div>",
            IE = "<div><p></p></div>")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "<div><span></span>nullundefinedhello</div>",
            IE = "<div><p></p></div>")
