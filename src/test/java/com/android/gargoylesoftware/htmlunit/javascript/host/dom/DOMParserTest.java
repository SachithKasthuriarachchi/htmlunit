...
public class DOMParserTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts("[object DOMParser]")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "parsererror",
            IE = "exception")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"5", "[object CDATASection]", "[object Comment]", "[object Element]",
