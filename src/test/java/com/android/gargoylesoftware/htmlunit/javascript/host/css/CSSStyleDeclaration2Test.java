...
<body onload='test()'>
  <textarea id='myTextarea' cols='120' rows='40'></textarea>
     ...
     */
    @Test
    @BrowserRunner.Alerts({"success", "success", "success", "success"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"borderBottomWidth 42% - 42em", "borderLeftWidth 42% - 42em",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"success", "success", "success", "success", "success", "success"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"success", "letterSpacing 42% - 42em",
