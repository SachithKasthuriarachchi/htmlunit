...
public class HTMLTableCellElementTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"left", "right", "3", "center", "8", "foo"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"p", "po", "", "u", "8", "U8"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"0", "4", "", "5.2", "-3", "abc"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"top", "baseline", "3", "middle", "8", "BOTtom"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"false", "null", "true", "", "true", "", "true", "blah", "false", "null"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"1", "3", "1", "2", "1", "5", "1", "2", "1"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"", "blah", "abc , xyz", "3", ""})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"100,42", "90,36"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"84,42", "84,42", "100,42", "82,36", "88,36", "90,36"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"84,34", "84,34", "84,34", "82,32", "82,32", "82,32"})
    @BrowserRunner.NotYetImplemented
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"100px", "200px", "400", "abc", "-5", "100.2", "10%"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"true", "true", "false", "false"})
