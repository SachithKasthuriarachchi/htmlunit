...
public class HTMLTableColElementTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"left", "right", "justify", "char", "center", "wrong", ""},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"CenTer", "8", "foo", "left", "right", "justify", "char", "center"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"1", "2", "1", "5", "1", "1"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"50", "75%", "foo", "-7", "20.2", "", "80", "40", "abc", "-10", "30%", "33.3"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"null", "string"},
            IE = {"", "string"})
     ...
     */
    @Test
    @BrowserRunner.Alerts("<table><colgroup><col></colgroup></table>")
