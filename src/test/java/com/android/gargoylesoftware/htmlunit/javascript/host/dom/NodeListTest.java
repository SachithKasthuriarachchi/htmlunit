...
public class NodeListTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "0,1,2,3,4,5,entries,forEach,item,keys,length,values",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"[object HTMLHtmlElement] 0 [object NodeList] undefined",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"done", "value", "object", "0", "[object HTMLHtmlElement]"},
            IE = "not defined",
            EDGE = "not defined")
