...
public class CharacterDataTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"Some New Text", "Some New Text"})
     ...
     */
    @Test
    @BrowserRunner.Alerts("Some Text Appended")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"Some Text", "Some", "Some", "me", ""})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"Some Not So New Te", "Some ", "So"},
     ...
     */
    @Test
    @BrowserRunner.Alerts("Some New Text")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"New", "Some New Text"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"Some ", "Text", "true"})
