...
public class HtmlUnitRegExpProxyGlobalPropertiesTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"Html,Html", "$n", "Html", "", "", "", "", "", "", "", "", "-", "Html", "Html", "1234",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"true", "$n", "", "", "", "", "", "", "", "", "", "-", "HtmlUnit", "", "1234", "xyz"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"true", "$n", "Html", "", "", "", "", "", "", "", "", "-", "HtmlUnit", "Html", "1234", "xyz"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"true", "$n", "Ht", "lU", "", "", "", "", "", "", "", "-", "HtmlUnit", "lU", "1234", "xyz"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"true", "$n", "H", "t", "m", "l", "U", "n", "i", "t", "x", "-", "HtmlUnitxy", "y", "1234", "z"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"true", "$n", "Html", "", "", "", "", "", "", "", "", "-", "Html", "Html", "1234",
