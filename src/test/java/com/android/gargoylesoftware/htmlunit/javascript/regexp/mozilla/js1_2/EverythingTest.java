...
public class EverythingTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts("Sally and Fred are sure to come")
     ...
     */
    @Test
    @BrowserRunner.Alerts("test123W+xyz,xyz")
     ...
     */
    @Test
    @BrowserRunner.Alerts("12365 number two 9898,12365,9898")
     ...
     */
    @Test
    @BrowserRunner.Alerts("See Spot run.,See Spot run.")
     ...
     */
    @Test
    @BrowserRunner.Alerts("I like it. What's up? I said NO!, I said NO!")
     ...
     */
    @Test
    @BrowserRunner.Alerts("the quick brown fox jumped over the lazy dogs,dogs,dogs")
