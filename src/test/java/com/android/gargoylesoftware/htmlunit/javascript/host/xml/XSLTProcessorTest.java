...
public class XSLTProcessorTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"function", "function", "function", "function", "function",
     ...
     */
    @Test
    @BrowserRunner.Alerts(FF = {"function", "function XSLTProcessor() {\n    [native code]\n}",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"[object XSLTProcessor]", "NaN", "true", "Yes", "Yes"},
