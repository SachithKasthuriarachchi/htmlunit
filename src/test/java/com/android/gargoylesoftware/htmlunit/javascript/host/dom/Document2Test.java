...
public class Document2Test extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"div1", "null", "2", "1"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"div1", "null", "0"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"parent", "child"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"parent", "child", "child3"},
            IE = "evaluate not available")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"div1", "null", "null"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"null", "text1"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"[object HTMLBodyElement]", "http://localhost:12345/#", "http://localhost:12345/#"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"<p>a & b</p> &amp; \u0162 \" '",
                        "<p>a & b</p> &amp; \u0162 \" '",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"true", "true", "true", "true", "true"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"bar", "null", "null"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"first", "newest"})
