...
public class HTMLBaseFontElementTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"[object HTMLElement]", "undefined", "undefined", "undefined"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"undefined", "42"},
            IE = {"4", "42"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"undefined", "helvetica"},
            IE = {"swiss", "helvetica"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"undefined", "blue"},
            IE = {"red", "blue"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"[object HTMLElement]", "exception"},
