...
public class KeyboardEvent2Test extends SimpleWebTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "keydown:65 keypress:97 keyup:65",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "keydown:113 keyup:113",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "keydown:39 keyup:39",
