...
public class XPathResultTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"4", "1", "3"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"7", "id1", "id2"},
            IE = "evaluate not supported")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"9", "id1"},
            IE = "evaluate not supported")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"id1", "id2"},
            IE = "evaluate not supported")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"bar", "foo", "foo"},
            IE = "evaluate not supported")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"true", "true", "true", "true", "true", "true"},
            IE = "evaluate not supported")
