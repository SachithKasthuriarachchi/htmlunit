...
public class HTMLIFrameElement3Test extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"1", "myIFrame"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"about:blank", "about:blank"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"[object HTMLDocument]", "true"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"false", "false", "true", "true", "true", "object", "object"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"123", "undefined"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"", "100", "foo", "20%", "-5", "30.2", "400", "abc", "-5", "100.2", "10%", "-12.56"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"uninitialized", "complete"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "128px",
            IE = "128")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"[object HTMLIFrameElement]", "[object HTMLIFrameElement]", "", ""},
     ...
     */
    @Test
    @BrowserRunner.Alerts("something")
     ...
     */
    @Test
    @BrowserRunner.Alerts("iframe onload")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"localhost", "localhost", "localhost", "localhost",
                "true", "true", "true"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"localhost", "localhost", "true"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"[object Window]", "topbody", "framebody", "[object Window]", "frame", "frameinput"})
    @Ignore
    // check expectations
