...
public class ComputedFontTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"", "16px", "2em", "32px", "150%", "24px"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(CHROME = {"15px arial, sans-serif", "normal normal 400 normal 15px / normal arial, sans-serif",
                "normal", "normal",
     ...
     */
    @Test
    @BrowserRunner.Alerts(CHROME = {"", "normal normal 400 normal 16px / normal \"Times New Roman\"",
                "", "\"Times New Roman\""},
            FF = {"", "", "", "serif"},
            IE = {"", "", "", "Times New Roman"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(CHROME = {"1px xyz", "normal normal 400 normal 1px / normal xyz",
     ...
     */
    @Test
    @BrowserRunner.Alerts(CHROME = {"1px/2px xyz", "normal normal 400 normal 1px / 2px xyz",
