...
public class HTMLElement2Test extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"undefined", "undefined", "undefined", "http://www.meh.com/meh"})
     ...
     */
    @Test
    @BrowserRunner.Alerts("attachEvent not available")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"15", "15"},
            FF = {"12", "12"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"1 absolute_auto 0", "2 absolute_length 50", "3 absolute_inherit 10", "4 fixed_auto 10",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"true", "true", "2", "3", "4", "5", "6", "7", "8", "9", "99", "199", "5999"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"30px", "46", "55px", "71", "71", "0", "0", "0", "0"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"0", "18"},
            FF = {"0", "20"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"75", "2", "5", "20", "50", "50", "18"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"1", "0.5", "true"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"something", "0"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"something", "0"},
            IE = {"something", "null"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"input handler", "blur input"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"input handler", "focus input"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"input handler", "click input", "div handler", "click div"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"null", "klazz"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"true", "center", "true", "center", "false"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"Old = <b>Old innerHTML</b><!-- old comment -->",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"Old = <b id=\"innerNode\">Old outerHTML</b>",
                "New =  <b><i id=\"newElt\">New cell value</i></b>",
                "I"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"clicked", "fireEvent not available"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"click", "fireEvent not available", "fireEvent not available"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {" body1", "", " body1 setActive not available"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"DIV,DIV,http://www.w3.org/1999/xhtml,null,div", "svg,svg,http://www.w3.org/2000/svg,null,svg",
