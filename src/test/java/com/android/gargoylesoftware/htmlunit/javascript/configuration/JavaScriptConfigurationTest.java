...
import org.apache.android.commons.text.RandomStringGenerator;
...
import com.android.gargoylesoftware.htmlunit.javascript.host.worker.DedicatedWorkerGlobalScope;
...
public class JavaScriptConfigurationTest extends SimpleWebTestCase {
    ...
    public void jsxClasses() {
        ...
        for (final String className : getClassesForPackage(JavaScriptEngine.class)) {
            if (!className.contains("$")) {
                ...
                if ("com.android.gargoylesoftware.htmlunit.javascript.host.intl".equals(klass.getPackage().getName())
    ...
    public void obsoleteJsxClasses() {
        final JavaScriptConfiguration config = JavaScriptConfiguration.getInstance(BrowserVersion.FIREFOX_60);
        final BrowserVersion[] browsers = new BrowserVersion[]
        {BrowserVersion.FIREFOX_60, BrowserVersion.FIREFOX_52, BrowserVersion.CHROME, BrowserVersion.INTERNET_EXPLORER, BrowserVersion.EDGE};
