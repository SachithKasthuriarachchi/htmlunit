...
public class HTMLScriptElementTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts("1 2 3 4 onload ")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"§§URL§§foo.js", "foo.js", "§§URL§§", ""})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"start", "end"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"start", "middle", "executed", "end"})
     ...
     */
    @Test
    @BrowserRunner.Alerts("start middle end executed")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"start", "executed", "end"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"script", "start", "end"})
     ...
     */
    @Test
    @BrowserRunner.Alerts("start end executed")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"executed", "start", "end"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"script-for", "exception", "script-body"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"1", "2", "3"},
            IE = "1")
     ...
     */
    @Test
    @BrowserRunner.Alerts("onload for window,")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"function foo() { return a > b}", "function mce() { return a &gt; b}"})
     ...
     */
    @Test
    @BrowserRunner.Alerts("undefined append append done from script undefined")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"false", "null", "true", "", "true", "", "false", "null"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"false", "null", "true", "true", "true", "", "true", "true", "false", "null"})
