...
import com.android.gargoylesoftware.htmlunit.WebClientInternals;
...
public class WebSocketTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"ws://localhost:12345/", "", "0", "blob"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"[object WebSocket]", "ws://localhost:12345/"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"exception undefined", "exception null", "exception empty", "exception invalid"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"blob", "blob", "arraybuffer", "blob", "blob"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({": myname=My value!1", ": myname=My value!2"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"onOpenListener", "onOpen",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"onError[object Event]",
