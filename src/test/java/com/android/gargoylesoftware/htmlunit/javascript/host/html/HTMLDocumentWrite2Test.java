...
public class HTMLDocumentWrite2Test extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts("Hello There")
     ...
     */
    @Test
    @BrowserRunner.Alerts("HelloHello")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"2", "§§URL§§foo"},
            IE = {"1", "§§URL§§"})
     ...
     */
    @Test
    @BrowserRunner.Alerts("<form></form>#[object HTMLFormElement]")
    // TODO [IE]SINGLE-VS-BULK test runs when executed as single but breaks as bulk
     ...
     */
    @Test
    @BrowserRunner.Alerts({"null", "[object HTMLBodyElement]", "s1 s2 s3 s4 s5"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"null", "[object HTMLBodyElement]", "", "foo"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"theBody", "theBody", "theBody"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"outer", "inner1"})
    public void writeAddNodesToCorrectParent_Bug1678826() throws Exception {
      ...
      */
    @Test
    @BrowserRunner.Alerts({"STYLE", "SCRIPT"})
