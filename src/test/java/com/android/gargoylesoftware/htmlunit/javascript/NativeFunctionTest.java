...
public class NativeFunctionTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"apply: function", "arguments: object", "call: function", "constructor: function",
            "toString: function"})
     ...
     */
    @Test
    @BrowserRunner.Alerts("bind: function")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "function anonymous() {\n    var x = 1;\n}",
     ...
     */
    @Test
    @BrowserRunner.Alerts("function foo() {\n  return 1;\n}")
     ...
     */
    @Test
    @BrowserRunner.Alerts("foo1 done")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"2", "eat", "bananas"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"t: [object Window]", "0", "t: ", "1", "a0: x",
                            "t: ab", "2", "a0: x", "a1: y"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"t: ab", "1", "a0: x,y"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"my x var", "my y var"})
     ...
     */
    @Test
    @BrowserRunner.Alerts("a=[object Window]")
