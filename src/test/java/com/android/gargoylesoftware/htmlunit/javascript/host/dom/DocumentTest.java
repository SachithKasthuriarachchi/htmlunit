...
public class DocumentTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"2", "form1", "form2"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"0", "1", "1", "true"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"0", "1", "1", "true", "name: end"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"0", "0", "0", "true"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"0", "3", "3", "true"},
            CHROME = {"0", "0", "0", "true"},
            FF60 = {"0", "0", "0", "true"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"0", "3", "3", "true", "firstEmbed"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"0", "3", "3", "true", "firstLink"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"parentNode: null", "DIV", "1", "null", "DIV", "button1value", "text1value", "text"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"DIV,DIV,http://www.w3.org/1999/xhtml,null,div",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"Some:Div", "Some:Div", "myNS", "Some", "Div", "svg", "svg", "http://www.w3.org/2000/svg", "null", "svg"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"Some Text", "9", "3", "Some Text", "#text"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"1", "exception"})
     ...
     */
    @Test
    @BrowserRunner.Alerts("Some Text")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"true", "true", "true", "true"})
     ...
     */
    @Test
    @BrowserRunner.Alerts("text/javascript")
     ...
     */
    @Test
    @BrowserRunner.Alerts("§§URL§§script/")
     ...
     */
    @Test
    @BrowserRunner.Alerts("parentDiv")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"true", "HTML", "true"})
     ...
     */
    @Test
    @BrowserRunner.Alerts("previousDiv")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"tangerine", "ginger"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"button", "button", "true"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"HTML", "HEAD", "TITLE", "SCRIPT", "BODY"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"HTML", "HEAD", "TITLE", "SCRIPT", "BODY"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"coll 2", "f4<->form4_1", "f4<->form4_2"},
            IE = "f4<->form4_1")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"coll 2", "f5_1<->form5", "f5_2<->form5"},
            IE = "f5_1<->form5")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"coll 2", "f6<->form6", "form6<->form6_2"},
            IE = "f6<->form6")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"false", "false", "undefined"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"null", "null", "null"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"value1", "value1", "value2", "value2"})
     ...
     */
    @Test
    @BrowserRunner.Alerts("IAmTheBody")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"0", "3", "3", "true", "firstImage"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"1", "2", "2", "true"})
     ...
     */
    @Test
    @BrowserRunner.Alerts("correct title")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"loading", "complete"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"null", "byId"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"myImageId", "2", "FORM", "undefined", "undefined", "undefined", "undefined"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"[object HTMLCollection]", "2"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"object", "FORM"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"true", "false"},
            IE = {"true", "true"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"undefined", "123"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"[object HTMLDocument]", "[object HTMLBodyElement]",
     ...
     */
    @Test
    @BrowserRunner.Alerts("#document-fragment_null_11_null_0_")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"true", "object", "[object Event]", "false"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"null", "null", "[object HTMLDivElement]"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "test",
            IE = "null")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "onload",
            IE = "undefined")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"[object StyleSheetList]", "0", "true"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"off", "off", "on", "on", "on", "off", "off", "off", "off"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"0", "0", "0"},
            FF = {"0", "1", "1"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "[object HTMLHeadingElement]",
            CHROME = "null",
            IE = "not available")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "[object HTMLHtmlElement]",
            IE = "not available")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"1: null", "2: null", "3: [object HTMLBodyElement]"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"1: [object HTMLBodyElement]", "2: [object HTMLBodyElement]"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"null", "text1", "not available"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"123", "captured"})
     ...
     */
    @Test
    @BrowserRunner.Alerts("[object Comment]")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"books", "books", "3", "#text", "0"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"undefined", "42"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"§§URL§§", "undefined"},
            IE = {"§§URL§§", "§§URL§§"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"1", "[object HTMLHtmlElement]"},
            IE = "not found")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"application/xml", "text/html"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"null", "null"},
            IE = {"", ""},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"false", "false"},
            FF = {"undefined", "undefined"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"1.0", "null"},
            FF = {"undefined", "undefined"},
            IE = {"1.0", ""})
