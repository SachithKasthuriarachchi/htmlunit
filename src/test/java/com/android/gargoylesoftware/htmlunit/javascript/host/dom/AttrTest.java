...
public class AttrTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"true", "exception thrown"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"undefined", "undefined", "undefined", "undefined", "undefined"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"[object Attr]", "", "[object Attr]", ""})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"[object Attr]", "undefined"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"[object Attr]", "§§URL§§"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"[object Attr]", "null"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"[object Attr]", "testattr"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"[object Attr]", "§§URL§§foo.xml"},
            IE = {"[object Attr]", "undefined"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"[object Attr]", "testAttr"})
