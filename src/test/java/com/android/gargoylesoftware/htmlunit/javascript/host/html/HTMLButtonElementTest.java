...
public class HTMLButtonElementTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"submit", "button", "submit"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"submit", "submit", "submit", "submit", "reset", "button", "submit"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"myFormId", "null", "null", "null", "null", "myFormId", "null", "myForm2Id", "myForm2Id"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"test", "4", "42", "2", "[object HTMLButtonElement]", "26"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"null", "4", "null", "4"})
     ...
     */
    @Test
    @BrowserRunner.Alerts("mouse over [btn]")
