...
public class RangeTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"true", "[object HTMLDocument]", "[object HTMLDocument]", "0", "[object HTMLDocument]", "0"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"false", "BODY", "BODY", "1", "BODY", "2"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"false", "DIV", "DIV", "0", "DIV", "2"})
     ...
     */
    @Test
    @BrowserRunner.Alerts("<div id=\"myDiv2\"></div><div>harhar</div><div id=\"myDiv3\"></div>")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"[object Text]", "[object HTMLTableRowElement]"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"qwerty", "tyxy", "[object DocumentFragment]", "[object HTMLSpanElement] [object Text]", "qwer",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"-1", "1", "1", "-1", "0"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"abcd", "bc", "null", "null", "ad", "bc"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"qwerty", "tyxy", "[object DocumentFragment]", "[object HTMLSpanElement] [object Text]",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"qwerty", "bcqwertyxy", "null", "az"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"abcd", "bc", "null", "null", "ad"})
