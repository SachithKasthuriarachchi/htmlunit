...
public class NamedNodeMapTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"name=f", "id=f", "foo=bar", "baz=blah"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"name", "f", "name", "f", "name", "f", "name", "f", "null"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT =  {"myattr", "myattr2", "myattr", "myattr2", "myattr2"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"name", "y", "name", "y", "null", "undefined", "null"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"true", "[object Attr]", "true", "[object Attr]"})
     ...
     */
    @Test
    @BrowserRunner.Alerts("media=\"screen\"")
     ...
     */
    @Test
    @BrowserRunner.Alerts("<input id=\"myinput\" name=\"test_input\">")
