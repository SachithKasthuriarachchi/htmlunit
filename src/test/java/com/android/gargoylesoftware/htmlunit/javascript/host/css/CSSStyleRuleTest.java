...
public class CSSStyleRuleTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"[object CSSStyleRule]", "1", "[object CSSStyleSheet]", "null", "h1", "", "10px", "", "red"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"4px", "4px", "4px", "4px"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"body", "h1", "a.foo", ".foo", ".foo .foo2", ".myFoo", "#byId"},
