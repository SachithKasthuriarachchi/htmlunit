...
public class MapTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"3", "value1"},
            IE = {"1", "undefined"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"function entries() { [native code] }",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"function values() { [native code] }",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"function keys() { [native code] }",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"1", "77", "one"},
            IE = "exception")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"value1", "key1", "[object Map]", "[object Window]",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"value1", "key1", "[object Map]", "hello",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "[object Map Iterator]",
            IE = {})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"value1", "undefined", "[object Map]", "[object Window]",
            "[object Object]", "key2", "[object Map]", "[object Window]"},
            IE = {})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"0", "Type error"})
