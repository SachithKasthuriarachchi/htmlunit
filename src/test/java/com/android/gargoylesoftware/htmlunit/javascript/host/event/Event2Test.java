...
public class Event2Test extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "[object Event] change b:true c:false [select] [-]"
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "[object MouseEvent] click b:true c:true [clickMe] [1]",
            IE = {""})
    @BrowserRunner.BuggyWebDriver(BrowserRunner.TestedBrowser.CHROME)
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "[object MouseEvent] click b:true c:true [radio] [1]"
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "[object MouseEvent] click b:true c:true [checkbox] [1]"
...
//                + "      onselect = 'dumpEvent(event);'\n"
     ...
     */
    @Test
    @BrowserRunner.Alerts("[object KeyboardEvent] keydown b:true c:true [typeHere] [65] "
...
//                + "    onselect = 'dumpEvent(event);'\n"
     ...
     */
    @Test
    @BrowserRunner.Alerts({"pass", "fail:66", "fail:undefined"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"object", "undefined", "undefined", "undefined", "undefined",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"DOMContentLoaded type=DOMContentLoaded", "onLoad"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"false", "not canceled", "true", "canceled", "true"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"false", "false", "SPAN"},
            FF = {"false", "true", "SPAN"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"capturing", "at target", "bubbling"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"window capturing", "div capturing", "span capturing",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"window capturing", "div capturing", "span capturing", "div", "window capturing", "false",
                "true"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"window capturing", "div capturing", "span capturing", "div", "window capturing", "false",
                "true"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"w", "w 2", "d", "d 2", "s", "s 2", "w", "w 2"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"w", "w 2", "d", "d 2", "s", "w"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "[object Event]",
            FF = "undefined")
