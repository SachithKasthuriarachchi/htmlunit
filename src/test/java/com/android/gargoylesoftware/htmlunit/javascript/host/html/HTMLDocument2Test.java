...
public class HTMLDocument2Test extends SimpleWebTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"www.gargoylesoftware.com", "gargoylesoftware.com"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"localhost", "gargoylesoftware.com"})
  ...
  /**
    ...
    */
     ...
     */
    @Test
    @BrowserRunner.Alerts({"d4.d3.d2.d1.gargoylesoftware.com", "d4.d3.d2.d1.gargoylesoftware.com", "d1.gargoylesoftware.com"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"localhost", "localhost"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"www.gargoylesoftware.com", "www.gargoylesoftware.com"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"one", "two", "three", "four"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"", "", "blah=bleh"})
