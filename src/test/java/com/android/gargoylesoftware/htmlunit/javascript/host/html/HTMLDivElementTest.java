...
public class HTMLDivElementTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"left", "right", "justify", "center", "wrong", ""},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"CenTer", "8", "foo", "left", "right", "justify", "center"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"null", "true", "null", "true"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"undefined", "null", "nowrap", "null", "x", "null", "x", "blah", "", "blah"},
