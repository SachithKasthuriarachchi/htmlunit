...
public class EventNodeTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts("fireEvent not available")
     ...
     */
    @Test
    @BrowserRunner.Alerts("createEventObject not available")
     ...
     */
    @Test
    @BrowserRunner.Alerts("mousedown span,mouseup span,click span,mousedown text,focus text,mouseup text,"
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "mousedown label,focus text,mouseup label,click label,click text,",
