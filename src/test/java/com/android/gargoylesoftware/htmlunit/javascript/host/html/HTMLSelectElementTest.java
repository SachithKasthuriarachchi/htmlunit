...
import com.android.gargoylesoftware.htmlunit.HttpMethod;
...
public class HTMLSelectElementTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"3", "value1", "One", "value2", "Two", "value3", "Three"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"false", "true", "true", "false"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"4", "Four", "value4"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"1", "true", "4", "Four", "value4", "true", "3", "false"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"4", "Four", "value4", "Three b", "value3b"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"0", "test", "testValue"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"0", "1", "0", "foo*"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"0", "1", "-1", "foo"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"3", "4", "1", "One", "Two*", "Three", "foo"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"3", "4", "2", "foo", "One", "Two*", "Three"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"3", "4", "2", "One", "foo", "Two*", "Three"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"3", "4", "1", "One", "Two*", "foo", "Three"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"0", "exception"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"3", "exception"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"0", "0", "-1"},
            IE = {"0", "exception"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"3", "3", "1", "One", "Two*", "Three"},
            IE = {"3", "exception"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"3", "2", "0", "Two*", "Three"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"3", "2", "0", "One*", "Three"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"3", "2", "1", "One", "Three*"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"3", "2", "1", "One", "Two*"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"3", "3", "1", "One", "Two*", "Three"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"2", "Three", "value3"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"1", "2", "", "", "foo", "fooValue"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"One", "value1"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"0", "true", "false", "false", "0"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"0", "false", "false", "false", "-1"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"1", "true", "false", "false", "0"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"1", "false", "false", "false", "-1"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"2", "false", "false", "false", "-1"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"true", "false", "false"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"first", "null", "null"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"two", "One"},
            IE = {"two", ""})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"One", "Two", "One"})
     ...
     */
    @Test
    @BrowserRunner.Alerts("mouse over")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"undefined", "[object HTMLOptionElement]", "2"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"undefined", "[object HTMLOptionElement]", "8"},
    ...
    @BrowserRunner.BuggyWebDriver(BrowserRunner.TestedBrowser.FF52)
