...
public class StorageTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"undefined", "[object Storage]", "[object Storage]"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"global: true", "local: true", "session: true"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"0", "2", "there", "world", "1", "0"})
     ...
     */
    @Test
    @BrowserRunner.Alerts("I was here")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"undefined", "null", "extraMethod called", "null"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"function", "null", "function", "value", "1"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"function", "null", "string", "value", "1"},
