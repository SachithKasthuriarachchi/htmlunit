...
import com.android.gargoylesoftware.htmlunit.javascript.configuration.AbstractJavaScriptConfiguration;
import com.android.gargoylesoftware.htmlunit.javascript.configuration.ClassConfiguration;
import com.android.gargoylesoftware.htmlunit.javascript.configuration.ClassConfiguration.PropertyInfo;
...
public class CSSStyleDeclarationTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"black", "pink", "color: pink;", "color: pink;"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"black", "pink", "color: pink; background: blue none repeat scroll 0% 0%;"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"null", "", "pink", "color: pink;"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"", "hidden", "undefined"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"string", "string", "string", "undefined"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "blue",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"*blue* string", ""})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"** string", "blue"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"30px", "", "30px", "arial", "", "arial"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"", "0.5", "0.4", "0.33333", "-3", "3", "", "", ""})
     ...
     */
    @Test
    @BrowserRunner.Alerts(" 0.5 0.4 0.33333 -3 3 8 7 7 7 7 7 ")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"undefined", "exception"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"3px", "4px", "2px", "1px"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"thin", "medium", "thick", "thick"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"undefined", "foo"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"string", "", "1", "2", "2", "2", "2", "5", "5", "5", "5"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"string", "", "string", "", "string", "4", "string", "", "string", "", "string", ""},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"", "", "15px", "italic", "", "italic"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"1px", "solid", "red"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"none", "rgb(0, 128, 0)", "none", "rgb(0, 128, 0)"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"block", "rgb(0, 0, 0)", "inline", "rgb(0, 0, 0)"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "not supported",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"red ", "black ", "blue important", "gray ", "green "})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"green ", "black important", "green "},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"4px", "5px", "6em", "auto", "7%", "initial", "inherit",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"4px", "5px", "6em", "auto", "70%", "initial", "inherit",
                        "17px", "17px", "17px", "", "17px", "", "17px", "17px", "17px"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"4px", "5px", "6em", "17px", "7%", "initial", "inherit",
                        "17px", "17px", "17px", "", "17px", "", "17px", "17px", "17px"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"4px", "5px", "6em", "17px", "70%", "initial", "inherit",
                        "17px", "17px", "17px", "", "17px", "", "17px", "17px", "17px"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"4px", "5px", "6em", "17px", "17px", "initial", "inherit",
                        "17px", "17px", "17px", "", "17px", "", "17px", "17px", "17px"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"17px", "5px", "6em", "17px", "17px", "initial", "inherit",
                        "17px", "17px", "17px", "", "17px", "", "17px", "17px", "17px"},
            IE = {"4px", "5px", "6em", "17px", "17px", "17px", "inherit",
                        "17px", "17px", "17px", "", "17px", "", "17px", "17px", "17px"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"thin", "medium", "thick"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"", "important", "", "important"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"black", "pink", "color: pink;", "color: pink;"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"5px", "undefined", "1em", "undefined"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"undefined", "none"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"1", "width", "undefined", "undefined"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"true", "true", "border-box"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"", "2", "", "2", "5", "5", "5", "5"},
            IE = {"", "2", "0", "0", "5", "5", "0", "0"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"", "static", "", "static", "", "static", "absolute", "absolute", "", "static"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"[object CSSStyleDeclaration]", "[object CSSStyleDeclaration]", "green", "abc"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"1", "false", "true", "false", "false"},
