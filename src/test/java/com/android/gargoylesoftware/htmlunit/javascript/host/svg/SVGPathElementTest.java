...
public class SVGPathElementTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "[object SVGPathElement]",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"[object SVGPathElement]", "true"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"[object SVGPathElement]", "647.213623046875"})
