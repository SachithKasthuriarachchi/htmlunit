...
public class HTMLTemplateElementTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"[object DocumentFragment]", "0-0",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"[object DocumentFragment]", "0-0", "1-0"},
            IE = "not available")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"", "", "<p></p>", "", "HtmlUnit", "<div>HtmlUnit</div><div>is great</div>"},
