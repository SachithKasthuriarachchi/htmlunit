...
public class XMLHttpRequestCORSTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"error [object ProgressEvent]", "error", "false", "0" /* "0" */},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"4", "200", "§§URL§§"},
            IE = {"4", "200", "No Origin!"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"4", "200", "null"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"exception", "4", "0"},
            IE = {"4", "200"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"4", "200", "§§URL§§", "§§URL§§", "GET", "x-pingother"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"4", "200", "options_headers", "x-ping,x-pong"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"false", "true", "false", "true"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"false", "false", "true", "false"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "1 0 4 0",
            IE = "1 0 4 200")
     ...
     */
    @Test
    @BrowserRunner.Alerts("1 0 4 200")
