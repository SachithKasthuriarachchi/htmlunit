...
public class HTMLTableRowElementTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"4", "td1", "3", "td2", "td4", "2", "td3", "exception", "exception"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"4", "exception", "4"},
            IE = {"4", "3"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"0", "0", "3", "1", "-1", "true", "false"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"cell1", "[object HTMLTableCellElement]", "abc", "[object Text]", ""},
