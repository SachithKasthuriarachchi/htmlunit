...
public class WebClient6Test extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"§§URL§§page2.html", "3"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"§§URL§§page2.html?test=foo", "3"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"§§URL§§page2.html#hash", "3"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"§§URL§§page2.html?test=foo#hash", "3"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"§§URL§§page2.html", "3"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"§§URL§§page2.html?test=foo", "3"},
            IE = {"§§URL§§redirect.html", "2"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"§§URL§§page2.html#hash", "3"},
            IE = {"§§URL§§redirect.html", "2"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"§§URL§§page2.html?test=foo#hash", "3"},
            IE = {"§§URL§§redirect.html", "2"})
