...
public class EncodingSnifferTest {
    ...
    private void header(final String expectedEncoding, final String headerName, final String headerValue) {
        ...
        Assert.assertEquals(expectedEncoding, EncodingSniffer.sniffEncodingFromHttpHeaders(singletonList(header)));
    }
    ...
    private void meta(final String expectedEncoding, final String content) {
        Assert.assertEquals(expectedEncoding, EncodingSniffer.sniffEncodingFromMetaTag(content.getBytes()));
    }
    ...
    private void xmlDeclaration(final String expectedEncoding, final String content) {
        Assert.assertEquals(expectedEncoding, EncodingSniffer.sniffEncodingFromXmlDeclaration(content.getBytes()));
    }
    ...
    private void contentType(final String expectedEncoding, final String contentType) {
        Assert.assertEquals(expectedEncoding, EncodingSniffer.extractEncodingFromContentType(contentType));
    }
