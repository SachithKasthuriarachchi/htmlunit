 ...
 */
package com.android.gargoylesoftware.htmlunit.protocol.data;
...
public class DataURLDecoderTest extends SimpleWebTestCase {
    ...
    public void testDecodeDataURL() throws Exception {
        DataUrlDecoder decoder = DataUrlDecoder.decodeDataURL("data:text/javascript,d1%20%3D%20'one'%3B");
        ...
        decoder = DataUrlDecoder.decodeDataURL("data:text/javascript;base64,ZDIgPSAndHdvJzs%3D");
        assertEquals("d2 = 'two';", decoder.getDataAsString());

        decoder = DataUrlDecoder.decodeDataURL(
        ...
        decoder = DataUrlDecoder.decodeDataURL("data:text/javascript;base64,%20ZD%20Qg%0D%0APS%20An%20Zm91cic%0D%0A%207%20");
        assertEquals("d4 = 'four';", decoder.getDataAsString());

        decoder = DataUrlDecoder.decodeDataURL("data:text/javascript,d5%20%3D%20'five%5Cu0027s'%3B");
