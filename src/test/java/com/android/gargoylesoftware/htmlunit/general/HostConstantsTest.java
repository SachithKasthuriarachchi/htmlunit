...
import com.android.gargoylesoftware.htmlunit.BrowserParameterizedRunner;
import com.android.gargoylesoftware.htmlunit.BrowserVersionFeatures;
import com.android.gargoylesoftware.htmlunit.TestCaseTest;
...
import com.android.gargoylesoftware.htmlunit.annotations.ToRunWithRealBrowsers;
...
public class HostConstantsTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserParameterizedRunner.Default
    ...
    private String getExpectedString() throws Exception {
        ...
        if ("Error".equals(host_) && getBrowserVersion().hasFeature(BrowserVersionFeatures.JS_ERROR_STACK_TRACE_LIMIT)) {
