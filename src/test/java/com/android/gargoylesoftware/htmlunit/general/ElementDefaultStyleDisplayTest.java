...
public class ElementDefaultStyleDisplayTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"", "inline"},
            FF52 = {"block", "inline"},
            FF60 = {"inline", "inline"},
            IE = {"inline", "inline"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"block", "block"},
            CHROME = {"", "block"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"", "inline-block"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"", "table-caption"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"", "block"},
            FF = {"block", "inline"},
            IE = {"block", "block"})
    @BrowserRunner.AlertsStandards(DEFAULT = {"block", "block"},
            CHROME = {"", "block"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"", "none"},
            FF52 = {"block", "inline"},
            FF60 = {"none", "none"},
            IE = {"inline", "inline"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"", "list-item"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"table", "table"},
            CHROME = {"", "table"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"", "table-column"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"", "table-column-group"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"", "table-row-group"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"", "table-cell"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"", "table-row"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"", "table-footer-group"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"", "table-header-group"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"", "contents"},
            FF52 = {"block", "inline"},
