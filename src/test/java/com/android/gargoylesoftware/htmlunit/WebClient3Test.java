...
public class WebClient3Test extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"open", "first", "second"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"Executed", "later"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "modified",
            IE = "Hello world")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "executed",
             IE = "")
    @BrowserRunner.NotYetImplemented(BrowserRunner.TestedBrowser.IE)
