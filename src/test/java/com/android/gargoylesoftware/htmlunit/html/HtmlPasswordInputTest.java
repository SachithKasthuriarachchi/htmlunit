...
public class HtmlPasswordInputTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"initial-initial-initial", "initial-initial-initial",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"initial-initial-initial", "default-default-default",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"textLength not available"},
            FF = {"7"})
