...
public class HtmlAnchorTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "page2.html",
            IE = "")
     ...
     */
    @Test
    @BrowserRunner.BuggyWebDriver(BrowserRunner.TestedBrowser.FF60)
     ...
     */
    @Test
    @BrowserRunner.Alerts("page2.html")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"My Link", "", "abcd"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"My Link 0", "Hello 0", " 1", "Hello 0", "a 2", "Hello 0"})
     ...
     */
    @Test
    @BrowserRunner.Alerts("<a id=\"a\" href=\"#x\">foo</a>")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"", "#anchor", "#!bang"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"#!board/WebDev", "#!article/WebDev/35", "#!article/WebDev/35"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(IE = "click href click doubleClick ",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"§§URL§§bug.html?h%C3%B6=G%C3%BCnter", "h\u00F6", "G\u00FCnter"})
     ...
     */
    @Test
    @BrowserRunner.BuggyWebDriver({BrowserRunner.TestedBrowser.IE, BrowserRunner.TestedBrowser.FF})
