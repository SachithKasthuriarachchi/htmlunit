...
public class HtmlLink2Test extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"onError", "body onLoad"},
     ...
     */
    @Test
    @BrowserRunner.Alerts("body onLoad")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"onLoad1", "onLoadJs1", "onLoad2", "body onLoad;"},
     ...
     */
    @Test
    @BrowserRunner.Alerts("onLoad [object Event]")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "onError [object Event]",
