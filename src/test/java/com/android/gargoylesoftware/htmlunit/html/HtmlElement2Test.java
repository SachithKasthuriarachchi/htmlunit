...
public class HtmlElement2Test extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"false", "true", "a", "a", "b", "b", "b", "c"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"true", "undefined", "undefined"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "down: 16,0 down: 49,0 press: 33,33 up: 49,0 up: 16,0"
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "[object HTMLInputElement] [object HTMLBodyElement]",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"[object HTMLHtmlElement]", "null"})
