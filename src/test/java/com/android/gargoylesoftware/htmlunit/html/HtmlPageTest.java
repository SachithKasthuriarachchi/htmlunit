...
import com.android.gargoylesoftware.htmlunit.ImmediateRefreshHandler;
...
public class HtmlPageTest extends SimpleWebTestCase {
    ...
    public void testHtmlAttributeChangeListener_AddAttribute() throws Exception {
        ...
        final HtmlPage page = loadPage(htmlContent);
        final HtmlElementTest.HtmlAttributeChangeListenerTestImpl listenerImpl = new HtmlElementTest.HtmlAttributeChangeListenerTestImpl();
    ...
    public void testHtmlAttributeChangeListener_ListenerRegistersNewListener() throws Exception {
        ...
        final HtmlAttributeChangeListener listener2 = new HtmlElementTest.HtmlAttributeChangeListenerTestImpl() {
            @Override
            public void attributeReplaced(final HtmlAttributeChangeEvent event) {
                collector.add("in listener 2");
            }
        };
        final HtmlAttributeChangeListener listener1 = new HtmlElementTest.HtmlAttributeChangeListenerTestImpl() {
            @Override
            public void attributeReplaced(final HtmlAttributeChangeEvent event) {
