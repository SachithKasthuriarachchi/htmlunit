...
public class HtmlNumberInputTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"1234", "1234"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"1234-1234-1234", "1234-1234-1234",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"1234-1234-1234", "2345-2345-2345",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"null,null", "null,null", "exception",
