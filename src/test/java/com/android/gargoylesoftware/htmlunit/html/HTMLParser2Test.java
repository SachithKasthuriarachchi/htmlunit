...
public class HTMLParser2Test extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"P", "BUTTON", "DIV"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"P", "LABEL", "OBJECT"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"2", "2", "3", "3", "2", "2", "3", "2", "2", "3", "2", "2"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"2", "2", "3", "3", "2", "2", "3", "2", "2", "3", "2", "2", "3"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"<!--[if gt IE 11]><br><![endif]-->", "<!--[if lt IE 11]><br><![endif]-->"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"<iframe></div></body></html></iframe>", "1",
                        "1", "IFRAME", "null", "1",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"2", "1-1#DL", "0-1#DT", "1-1#DL", "0-1#DT"})
