...
public class MalformedHtmlTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"in test", "BODY"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"2", "3", "text3", "text3", "null"})
     ...
     */
    @Test
    @BrowserRunner.Alerts("Test document")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"DIV", "TABLE"})
    ...
    */
    @Test
    @BrowserRunner.Alerts({"submit", "button"})
    ...
    */
     ...
     */
    @Test
    @BrowserRunner.Alerts("inFirst inSecond")
    ...
    * Regression test for bug 1562.
     ...
     */
    @Test
    @BrowserRunner.Alerts("hello world")
    ...
    * Regression test for bug 1598.
     ...
     */
    @Test
    @BrowserRunner.Alerts({"1", "TABLE", "2", "FORM", "TBODY"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"3", "1a", "1b", "1c", "0", "TBODY", "3", "2a", "2b", "2c", "0", "TBODY"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"3", "1a", "1b", "", "0", "TABLE"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"3", "1a", "1b", "", "0", "DIV"})
    @BrowserRunner.NotYetImplemented
     ...
     */
    @Test
    @BrowserRunner.Alerts({"1", "1a", "0", "TR", "1", "2a", "0", "TR"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"2", "1a", "1b", "0", "TR"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"3", "1a", "1b", "1c", "0", "TR", "1", "2a", "1", "DIV"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"2", "1a", "1b", "2", "BODY", "TR", "TABLE", "2"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"3", "1b", "1a", "1c", "0", "TABLE"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"1", "form1_submit", "0", "TABLE"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"<div>caption</div>", "TABLE"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"2", "input1", "submit1", "1", "LI", "2", "input2", "submit2", "2", "DIV"})
     ...
     */
    @Test
    @BrowserRunner.Alerts("frame loaded")
     ...
     */
    @Test
    @BrowserRunner.Alerts("§§URL§§foo?a=1&copy=2&prod=3")
    @BrowserRunner.NotYetImplemented
