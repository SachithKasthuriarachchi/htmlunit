...
public class FocusableElement2Test extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"onfocus", "onblur"},
    ...
    */
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "done\nfocus",
            CHROME = "done")
    ...
    @BrowserRunner.Alerts({"input1", "focus1", "div", "input2", "blur1", "focus2"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"focus1", "blur1"})
