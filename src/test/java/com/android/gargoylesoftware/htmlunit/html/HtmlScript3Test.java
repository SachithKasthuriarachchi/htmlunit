...
public class HtmlScript3Test extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"a", "ä", "أهلاً", "мир", "房间"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"a", "Ã¤", "Ø£Ù‡Ù„Ø§Ù‹", "Ð¼Ð¸Ñ€", "æˆ¿é—´"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"a", "ä", "أهلاً", "мир", "房间"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"a", "盲", "兀賴賱丕賸", "屑懈褉", "鎴块棿"})
