...
public class HtmlPage3Test extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"[object HTMLInputElement]", "1"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"[object SVGSVGElement]", "http://www.w3.org/2000/svg",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "Something",
            FF60 = "error",
            IE = "error")
    @BrowserRunner.NotYetImplemented({BrowserRunner.TestedBrowser.IE, BrowserRunner.TestedBrowser.FF60})
