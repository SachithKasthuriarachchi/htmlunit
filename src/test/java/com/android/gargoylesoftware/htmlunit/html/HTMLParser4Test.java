...
public class HTMLParser4Test extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"4", "[object HTMLScriptElement]", "[object Text]",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"4", "[object HTMLParagraphElement]", "[object Text]",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"from script", "from body"})
     ...
     */
    @Test
    @BrowserRunner.Alerts("<html><head><title>foo</title></head>"
     ...
     */
    @Test
    @BrowserRunner.Alerts("<p title=\"Nimbus\ufffd X\">Nimbus\ufffd X</p>")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"1", "3", "[object HTMLScriptElement]",
...
//    }
     ...
     */
    @Test
    @BrowserRunner.Alerts({"titles", "HEAD", "Outer Html", "DIV", "Inner Html",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"titles", "HEAD", "Inner Html", "misc", "true", "BODY"})
    @BrowserRunner.NotYetImplemented
