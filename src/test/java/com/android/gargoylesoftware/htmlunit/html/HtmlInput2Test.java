...
public final class HtmlInput2Test extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"null", "error", "handler", "null", "error"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"function handler() {}", "null"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"mousedown; onfocus; mouseup; onclick;", ""})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"mousedown; onfocus; mouseup; onclick; onchange;", ""},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"mousedown; onfocus; mouseup; onchange; onclick;", ""})
