...
public class HtmlRadioButtonInput2Test extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"true", "true-true", "true-false", "true-false", "true-false", "true-false", "true-false"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"false", "false-true", "false-true", "false-true", "true-true", "true-false", "true-false"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"true", "true-false", "true-false", "true-false", "true-false", "true-false"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"false", "false-true", "false-true", "true-true", "true-false", "true-false"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"true-true", "false-false", "true-true", "false-false", "false-false", "false-false"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"false-false", "false-false", "true-true", "false-false", "false-false", "false-false"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"send request", "response read"})
     ...
     */
    @Test
    @BrowserRunner.Alerts("foo,change,boo,blur,")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"on-", "on-", "on-", "on-"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"initial-initial", "initial-initial", "newValue-newValue", "newValue-newValue",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"initial-initial", "default-default", "newValue-newValue", "newDefault-newDefault"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"false,false", "true,false", "false,true"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"true", "null", "true", "", "true", "yes"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"false", "null", "true", "null", "false", "null", "true", "", "false", "",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"false", "null", "false", "null", "true", "", "true", "",
                        "true", "yes", "true", "yes"})
