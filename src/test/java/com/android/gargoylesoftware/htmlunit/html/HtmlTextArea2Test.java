...
public class HtmlTextArea2Test extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"-", "-", "newValue-", "newValue-", "newValue-newDefault", "newValue-newDefault"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"-", "default-default", "some text-default", "some text-newdefault"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"7"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"0,0", "11,11", "3,11", "3,10"},
            IE = {"0,0", "0,0", "3,3", "3,10"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"0,0", "11,11", "0,11", "0,11"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"0,0", "11,11", "10,11", "5,5"},
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"0,0", "4,5", "10,10", "4,4", "1,1"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"1", "a", "", "b", "<!--comment-->2", "c", "<!--comment-->", "d"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"", "xyz", "1", "a", "1"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"", "", "1", "a", "1"},
            IE = {"", "123", "1", "a", "1"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"", "", "1", "xyz", "2", "a", "2"},
