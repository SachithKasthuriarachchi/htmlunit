...
public class HtmlForm2Test extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"myForm", "TypeError"},
            IE = {"myForm", "myForm"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"error", "error", "error"},
     ...
     */
    @Test
    @BrowserRunner.Alerts({"§§URL§§?par%F6m=Hello+G%FCnter", "par\u00F6m", "Hello G\u00FCnter"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(CHROME = "text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "gzip, deflate",
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "third content",
            IE = "second content")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "GET",
            IE = "POST")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "application/x-www-form-urlencoded",
     ...
     */
    @Test
    @BrowserRunner.Alerts("second content")
