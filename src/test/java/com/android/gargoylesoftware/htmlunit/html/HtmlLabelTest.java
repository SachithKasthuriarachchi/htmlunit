...
public class HtmlLabelTest extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"labelclick", "chboxclick"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"click radio1Label", "click listItem1", "click list",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"click span1", "click radio1Label", "click listItem1", "click list",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"click radio1", "click radio1Label", "click listItem1", "click list"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"click check1Label", "click listItem1", "click list",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"click span1", "click check1Label", "click listItem1", "click list",
     ...
     */
    @Test
    @BrowserRunner.Alerts({"click check1", "click check1Label", "click listItem1", "click list"})
