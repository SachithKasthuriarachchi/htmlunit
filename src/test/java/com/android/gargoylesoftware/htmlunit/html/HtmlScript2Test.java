...
public class HtmlScript2Test extends WebDriverTestCase {
     ...
     */
    @Test
    @BrowserRunner.Alerts({"created", "hello", "replaced"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"deferred", "normal", "onload"})
     ...
     */
    @Test
    @BrowserRunner.Alerts("var x=1;x=2;")
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"s-x", "z"},
            IE = {"s-x", "x", "z"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"loaded", "§§URL§§abcd"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"onLoad", "body onLoad"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = {"onLoad", "body onLoad"},
            IE = "body onLoad")
     ...
     */
    @Test
    @BrowserRunner.Alerts({"onError", "body onLoad"})
     ...
     */
    @Test
    @BrowserRunner.Alerts({"from script", "onLoad [object Event]"})
     ...
     */
    @Test
    @BrowserRunner.Alerts(DEFAULT = "[object HTMLScriptElement]",
            IE = "undefined")
