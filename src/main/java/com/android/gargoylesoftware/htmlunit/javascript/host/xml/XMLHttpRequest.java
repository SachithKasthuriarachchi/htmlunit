...
public class XMLHttpRequest extends XMLHttpRequestEventTarget {
    ...
    private void setState(final int state, Context context) {
        ...
        if (state == DONE) {
            ...
            final boolean lengthComputable = browser.hasFeature(BrowserVersionFeatures.XHR_LENGTH_COMPUTABLE);
            if (lengthComputable) {
                        ...
                        public Charset getContentCharset() {
                            if (charsetNameFinal.isEmpty()
                                    || (charsetFinal == null && getBrowserVersion()
                                                .hasFeature(BrowserVersionFeatures.XHR_USE_CONTENT_CHARSET))) {
