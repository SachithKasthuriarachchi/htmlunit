...
import static com.android.gargoylesoftware.htmlunit.BrowserVersionFeatures.GENERATED_176;
...
public class Selection extends SimpleScriptable {
    ...
    public void addRange(final com.android.gargoylesoftware.htmlunit.javascript.host.Range range) {
     ...
     */
    @JsxFunction(@WebBrowser(FF))
    public void removeRange(final com.android.gargoylesoftware.htmlunit.javascript.host.Range range) {
     ...
     */
    @JsxFunction(@WebBrowser(FF))
    public com.android.gargoylesoftware.htmlunit.javascript.host.Range getRangeAt(final int index) {
        final List<Range> ranges = getRanges();
        if (index < 0 || index >= ranges.size()) {
            throw Context.reportRuntimeError("Invalid range index: " + index);
        }
        final Range range = ranges.get(index);
        final com.android.gargoylesoftware.htmlunit.javascript.host.Range jsRange =
            new com.android.gargoylesoftware.htmlunit.javascript.host.Range(range);
        jsRange.setParentScope(getWindow());
        jsRange.setPrototype(getPrototype(com.android.gargoylesoftware.htmlunit.javascript.host.Range.class));
