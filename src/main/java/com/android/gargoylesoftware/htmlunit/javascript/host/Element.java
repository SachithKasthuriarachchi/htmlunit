...
import com.android.gargoylesoftware.htmlunit.javascript.host.html.HTMLElement.ProxyDomNode;
...
public class Element extends Node {
    ...
    public void setInnerHTML(final Object value) {
        ...
        final boolean addChildForNull = getBrowserVersion().hasFeature(BrowserVersionFeatures.JS_INNER_HTML_ADD_CHILD_FOR_NULL_VALUE);
        ...
        if (node instanceof DomComment) {
            ...
            if (node instanceof HtmlElement) {
                ...
                if ("p".equals(element.getTagName())) {
                    if (getBrowserVersion().hasFeature(BrowserVersionFeatures.JS_INNER_TEXT_LF)) {
