...
public class HtmlUnitContextFactory extends ContextFactory {
    ...
    protected Context makeContext() {
        ...
        if (browserVersion_.hasFeature(BrowserVersionFeatures.JS_PRE_WIDTH_STRING)) {
    ...
    protected boolean hasFeature(final Context cx, final int featureIndex) {
        switch (featureIndex) {
            ...
            case Context.FEATURE_HTMLUNIT_MEMBERBOX_NAME:
                return browserVersion_.hasFeature(BrowserVersionFeatures.JS_PROPERTY_DESCRIPTOR_NAME);
            case Context.FEATURE_HTMLUNIT_MEMBERBOX_NEWLINE:
                return browserVersion_.hasFeature(BrowserVersionFeatures.JS_PROPERTY_DESCRIPTOR_NEW_LINE);
            case Context.FEATURE_HTMLUNIT_ARRAY_PROPERTIES:
                return browserVersion_.hasFeature(BrowserVersionFeatures.JS_ARRAY_CONSTRUCTION_PROPERTIES);
            default:
