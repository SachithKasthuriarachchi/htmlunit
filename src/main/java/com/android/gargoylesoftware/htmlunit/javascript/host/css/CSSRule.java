...
public class CSSRule extends SimpleScriptable {
     ...
     */
    @JsxConstant({SupportedBrowser.FF52, SupportedBrowser.IE, SupportedBrowser.EDGE})
     ...
     * The rule is a {@code CSSKeyframesRule}.
     */
    @JsxConstant(SupportedBrowser.FF52)
     ...
     */
    @JsxConstructor({SupportedBrowser.CHROME, SupportedBrowser.FF60, SupportedBrowser.EDGE})
    public CSSRule() {
        stylesheet_ = null;
        rule_ = null;
    }
