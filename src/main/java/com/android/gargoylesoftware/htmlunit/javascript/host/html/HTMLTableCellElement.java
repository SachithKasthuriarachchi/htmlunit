...
public class HTMLTableCellElement extends HTMLTableComponent {
    ...
    public int getOffsetHeight() {
        ...
        final boolean includeBorder = getBrowserVersion().hasFeature(BrowserVersionFeatures.JS_TABLE_CELL_OFFSET_INCLUDES_BORDER);
    ...
    public int getOffsetWidth() {
        ...
        if ("collapse".equals(style.getStyleAttribute(StyleAttributes.Definition.BORDER_COLLAPSE))) {
            ...
            if (row != null) {
                ...
                final boolean ie = getBrowserVersion().hasFeature(BrowserVersionFeatures.JS_TABLE_CELL_OFFSET_INCLUDES_BORDER);
    ...
    public void setRowSpan(final String rowSpan) {
        try {
            ...
            if (i < 0 && getBrowserVersion().hasFeature(BrowserVersionFeatures.JS_TABLE_SPAN_SET_ZERO_IF_INVALID)) {
            ...
            if (getBrowserVersion().hasFeature(BrowserVersionFeatures.JS_TABLE_SPAN_SET_ZERO_IF_INVALID)) {
    ...
    public String getWidth_js() {
        final boolean ie = getBrowserVersion().hasFeature(BrowserVersionFeatures.JS_TABLE_CELL_WIDTH_DOES_NOT_RETURN_NEGATIVE_VALUES);
    ...
    public String getHeight_js() {
        final boolean ie = getBrowserVersion().hasFeature(BrowserVersionFeatures.JS_TABLE_CELL_HEIGHT_DOES_NOT_RETURN_NEGATIVE_VALUES);
        final Boolean returnNegativeValues = ie ? Boolean.TRUE : null;
