...
import static com.android.gargoylesoftware.htmlunit.BrowserVersionFeatures.JS_XML_SERIALIZER_ADD_XHTML_NAMESPACE;
import static com.android.gargoylesoftware.htmlunit.BrowserVersionFeatures.JS_XML_SERIALIZER_APPENDS_CRLF;
import static com.android.gargoylesoftware.htmlunit.BrowserVersionFeatures.JS_XML_SERIALIZER_NODE_AS_UPPERCASE;
import static com.android.gargoylesoftware.htmlunit.BrowserVersionFeatures.JS_XML_SERIALIZER_NON_EMPTY_TAGS;
        ...
        for (final DomNode child : node.getChildren()) {
            ...
            switch (child.getNodeType()) {
                ...
                case Node.TEXT_NODE:
                    ...
                    if (appendCrLf && org.apache.android.commons.lang3.StringUtils.isBlank(value)) {
                        buffer.append("\r\n");
