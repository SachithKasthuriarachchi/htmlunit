...
public class Selection extends SimpleScriptable {
     ...
     */
    @JsxFunction
    public void addRange(final com.android.gargoylesoftware.htmlunit.javascript.host.dom.Range range) {
     ...
     */
    @JsxFunction
    public void removeRange(final com.android.gargoylesoftware.htmlunit.javascript.host.dom.Range range) {
     ...
     */
    @JsxFunction
    public com.android.gargoylesoftware.htmlunit.javascript.host.dom.Range getRangeAt(final int index) {
        final List<Range> ranges = getRanges();
        if (index < 0 || index >= ranges.size()) {
            throw Context.reportRuntimeError("Invalid range index: " + index);
        }
        final Range range = ranges.get(index);
        final com.android.gargoylesoftware.htmlunit.javascript.host.dom.Range jsRange =
            new com.android.gargoylesoftware.htmlunit.javascript.host.dom.Range(range);
        jsRange.setParentScope(getWindow());
        jsRange.setPrototype(getPrototype(com.android.gargoylesoftware.htmlunit.javascript.host.dom.Range.class));
     ...
     */
    @JsxFunction({SupportedBrowser.CHROME, SupportedBrowser.FF60})
    public void empty() {
        removeAllRanges();
    }
