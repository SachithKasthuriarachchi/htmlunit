...
import com.android.gargoylesoftware.htmlunit.html.HtmlBlockQuote;
 ...
 * @author Ahmed Ashour
 */
@JsxClass(domClass = HtmlAddress.class, value = SupportedBrowser.IE)
@JsxClass(domClass = HtmlBlockQuote.class, value = SupportedBrowser.IE)
@JsxClass(domClass = HtmlCenter.class, value = SupportedBrowser.IE)
@JsxClass(domClass = HtmlExample.class, value = SupportedBrowser.IE)
@JsxClass(domClass = HtmlListing.class, value = SupportedBrowser.IE)
@JsxClass(domClass = HtmlPlainText.class, value = SupportedBrowser.IE)
