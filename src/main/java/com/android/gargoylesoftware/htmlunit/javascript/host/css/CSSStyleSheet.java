...
import com.android.gargoylesoftware.htmlunit.html.HtmlOption;
...
public class CSSStyleSheet extends StyleSheet {
    ...
    private void refreshCssRules() {
        ...
        for (CSSRule rule : rules) {
            ...
            final com.android.gargoylesoftware.htmlunit.javascript.host.css.CSSRule cssRule
                        = com.android.gargoylesoftware.htmlunit.javascript.host.css.CSSRule.create(this, rule);
            if (null == cssRule) {
                cssRulesIndexFix_.add(pos);
            }
            else {
