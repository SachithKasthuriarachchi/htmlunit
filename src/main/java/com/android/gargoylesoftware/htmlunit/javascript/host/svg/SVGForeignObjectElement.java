...
import com.android.gargoylesoftware.htmlunit.svg.SvgForeignObject;
 ...
 * @author Frank Danek
 */
@JsxClass(domClass = SvgForeignObject.class, value = {SupportedBrowser.FF, SupportedBrowser.CHROME, SupportedBrowser.EDGE})
