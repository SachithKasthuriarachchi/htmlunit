...
public class Location extends SimpleScriptable {
    ...
    public String getHref() {
        ...
        try {
            URL url = page.getUrl();
            final boolean encodeHash = getBrowserVersion().hasFeature(BrowserVersionFeatures.JS_LOCATION_HREF_HASH_IS_ENCODED);
    ...
    public String getHash() {
        ...
        else if (getBrowserVersion().hasFeature(BrowserVersionFeatures.JS_LOCATION_HASH_HASH_IS_ENCODED)) {
