...
import com.android.gargoylesoftware.htmlunit.svg.SvgAnimateMotion;
 ...
 * @author Frank Danek
 */
@JsxClass(domClass = SvgAnimateMotion.class, value = {SupportedBrowser.FF, SupportedBrowser.CHROME})
