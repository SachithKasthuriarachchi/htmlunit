...
import com.android.gargoylesoftware.htmlunit.javascript.host.WindowProxy;
...
public class HTMLIFrameElement extends HTMLElement {
    ...
    public ScriptResult executeEventLocally(final Event event) {
        if (Event.TYPE_LOAD != event.getType()
                || !isAttachedToPageDuringOnload_ || getBrowserVersion().hasFeature(BrowserVersionFeatures.JS_IFRAME_ALWAYS_EXECUTE_ONLOAD)) {
