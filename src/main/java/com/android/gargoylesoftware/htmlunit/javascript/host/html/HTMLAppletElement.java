 ...
 */
@JsxClass(domClass = HtmlApplet.class, value = {SupportedBrowser.FF52, SupportedBrowser.IE, SupportedBrowser.EDGE})
public class HTMLAppletElement extends HTMLElement {

    /**
     * The constructor.
     */
    @JsxConstructor({SupportedBrowser.FF52, SupportedBrowser.EDGE})
