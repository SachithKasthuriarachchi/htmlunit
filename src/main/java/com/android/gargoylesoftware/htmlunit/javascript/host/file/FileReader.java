...
public class FileReader extends EventTarget {
    ...
    public void readAsDataURL(final Object object) throws IOException {
        ...
        try (ByteArrayOutputStream bos = new ByteArrayOutputStream()) {
            ...
            result_ = "data:";
            final boolean includeConentType = browserVersion.hasFeature(BrowserVersionFeatures.JS_FILEREADER_CONTENT_TYPE);
            ...
            if (value.isEmpty() && getBrowserVersion().hasFeature(BrowserVersionFeatures.JS_FILEREADER_EMPTY_NULL)) {
                result_ = "null";
            }
        }
        readyState_ = DONE;
