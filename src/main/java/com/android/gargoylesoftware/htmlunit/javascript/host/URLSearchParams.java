...
public class URLSearchParams extends SimpleScriptable {
    ...
    private static com.android.gargoylesoftware.htmlunit.javascript.host.Iterator ITERATOR_PROTOTYPE_;
    ...
    public Object entries() {
        final SimpleScriptable object =
                new com.android.gargoylesoftware.htmlunit.javascript.host.Iterator(ITERATOR_NAME, params_.iterator());
    ...
    public Object keys() {
        ...
        final SimpleScriptable object =
                new com.android.gargoylesoftware.htmlunit.javascript.host.Iterator(ITERATOR_NAME, keys.iterator());
        object.setParentScope(getParentScope());
        setIteratorPrototype(object);
        return object;
    }
    ...
    public Object values() {
        ...
        final SimpleScriptable object =
                new com.android.gargoylesoftware.htmlunit.javascript.host.Iterator(ITERATOR_NAME, values.iterator());
        object.setParentScope(getParentScope());
        setIteratorPrototype(object);
        return object;
    }
    ...
    private static void setIteratorPrototype(final Scriptable scriptable) {
        if (ITERATOR_PROTOTYPE_ == null) {
            ITERATOR_PROTOTYPE_ = new com.android.gargoylesoftware.htmlunit.javascript.host.Iterator(ITERATOR_NAME, null);
        }
     ...
     * @see SimpleScriptable#getDefaultValue(java.lang.Class)
