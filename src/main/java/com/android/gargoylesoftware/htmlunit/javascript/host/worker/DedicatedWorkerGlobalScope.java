 ...
 */
package com.android.gargoylesoftware.htmlunit.javascript.host.worker;
...
import com.android.gargoylesoftware.htmlunit.javascript.background.BasicJavaScriptJob;
...
@JsxClass(className = "WorkerGlobalScope", value = SupportedBrowser.IE)
