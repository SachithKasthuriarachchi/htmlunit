...
public class HTMLDocument extends Document {
    ...
    public HTMLCollection getElementsByName(final String elementName) {
        ...
        if ("null".equals(elementName)
                || (elementName.isEmpty()
                    && getBrowserVersion().hasFeature(BrowserVersionFeatures.HTMLDOCUMENT_ELEMENTS_BY_NAME_EMPTY))) {
        ...
        return new HTMLCollection(page, true) {
            ...
            @Override
            protected AbstractList.EffectOnCache getEffectOnCache(final HtmlAttributeChangeEvent event) {
