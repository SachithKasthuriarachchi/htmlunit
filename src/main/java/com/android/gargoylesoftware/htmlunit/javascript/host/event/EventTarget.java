...
import com.android.gargoylesoftware.htmlunit.html.HtmlLabel;
...
public class EventTarget extends SimpleScriptable {
    ...
    public ScriptResult fireEvent(final Event event) {
        ...
        try {
            ...
            final boolean windowEventIfDetached = getBrowserVersion().hasFeature(BrowserVersionFeatures.JS_EVENT_WINDOW_EXECUTE_IF_DITACHED);
            ...
            final boolean ie = getBrowserVersion().hasFeature(BrowserVersionFeatures.JS_CALL_RESULT_IS_LAST_RETURN_VALUE);
