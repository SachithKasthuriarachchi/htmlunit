...
import com.android.gargoylesoftware.htmlunit.svg.SvgAnimateTransform;
 ...
 * @author Frank Danek
 */
@JsxClass(domClass = SvgAnimateTransform.class, value = {SupportedBrowser.FF, SupportedBrowser.CHROME})
