...
public final class HtmlUnitCookieStore implements CookieStore, Serializable {
    ...
    public synchronized void addCookie(final Cookie cookie) {
        manager_.addCookie(new com.android.gargoylesoftware.htmlunit.util.Cookie((ClientCookie) cookie));
    }
    ...
    public synchronized List<Cookie> getCookies() {
        return com.android.gargoylesoftware.htmlunit.util.Cookie.toHttpClient(manager_.getCookies());
    }
