...
import com.android.gargoylesoftware.htmlunit.protocol.AnyHandler;
...
public final class UrlUtils {
    ...
    private static final URLStreamHandler ABOUT_HANDLER = new com.android.gargoylesoftware.htmlunit.protocol.about.Handler();
...
//        allowedFragment.clear('%');
    ...
    public static URL toUrlUnsafe(final String url) throws MalformedURLException {
        ...
        final String protocol = org.apache.android.commons.lang3.StringUtils.substringBefore(url, ":").toLowerCase(Locale.ROOT);
        ...
        if (protocol.isEmpty() || UrlUtils.isNormalUrlProtocol(protocol)) {
            ...
            if (response.getProtocol().startsWith("http")
                    && org.apache.android.commons.lang3.StringUtils.isEmpty(response.getHost())) {
        ...
        if ("about".equals(protocol)) {
            if (WebClient.URL_ABOUT_BLANK != null
                    && org.apache.android.commons.lang3.StringUtils.
