...
import com.android.gargoylesoftware.htmlunit.WebConnection;
import com.android.gargoylesoftware.htmlunit.WebRequest;
import com.android.gargoylesoftware.htmlunit.WebResponse;
import com.android.gargoylesoftware.htmlunit.WebResponseData;
...
public class DebuggingWebConnection extends WebConnectionWrapper {
    ...
    private File createFile(final URL url, final String extension) throws IOException {
        ...
        name = com.android.gargoylesoftware.htmlunit.util.StringUtils.sanitizeForFileName(name);
