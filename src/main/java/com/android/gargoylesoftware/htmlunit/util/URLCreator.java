 ...
 */
package com.android.gargoylesoftware.htmlunit.util;
...
import com.android.gargoylesoftware.htmlunit.protocol.javascript.Handler;
...
abstract class URLCreator {
    ...
    static class URLCreatorStandard extends URLCreator {
        ...
        private static final URLStreamHandler ABOUT_HANDLER
            = new com.android.gargoylesoftware.htmlunit.protocol.about.Handler();
        private static final URLStreamHandler DATA_HANDLER = new com.android.gargoylesoftware.htmlunit.protocol.data.Handler();

        @Override
        URL toUrlUnsafeClassic(final String url) throws MalformedURLException {
            if (org.apache.android.commons.lang3.StringUtils.startsWithIgnoreCase(url,
                    JavaScriptURLConnection.JAVASCRIPT_PREFIX)) {
                return new URL(null, url, JS_HANDLER);
            }
            else if (org.apache.android.commons.lang3.StringUtils.startsWithIgnoreCase(url, "about:")) {
                if (WebClient.URL_ABOUT_BLANK != null
                        && org.apache.android.commons.lang3.StringUtils.equalsIgnoreCase(
                                WebClient.URL_ABOUT_BLANK.toExternalForm(), url)) {
                    return WebClient.URL_ABOUT_BLANK;
                }
                return new URL(null, url, ABOUT_HANDLER);
            }
            else if (org.apache.android.commons.lang3.StringUtils.startsWithIgnoreCase(url, "data:")) {
    ...
    static class URLCreatorGAE extends URLCreator {
        ...
        URL toUrlUnsafeClassic(final String url) throws MalformedURLException {
            ...
            else if (org.apache.android.commons.lang3.StringUtils.startsWithIgnoreCase(url,
                    JavaScriptURLConnection.JAVASCRIPT_PREFIX)) {
