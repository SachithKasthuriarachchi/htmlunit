...
public abstract class BaseFrameElement extends HtmlElement {
     ...
     *      {@link WebClientOptions#setThrowExceptionOnFailingStatusCode(boolean)} is
     *      set to true
     */
     ...
     * later overwriting from method com.android.gargoylesoftware.htmlunit.html.HtmlPage.loadFrames().
     */
