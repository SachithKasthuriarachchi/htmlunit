...
import com.android.gargoylesoftware.htmlunit.util.MimeType;
...
class XmlSerializer {
    ...
    protected void printOpeningTag(final DomElement node) throws IOException {
        ...
        for (final Map.Entry<String, DomAttr> entry : attributes.entrySet()) {
            ...
            builder_.append(com.android.gargoylesoftware.htmlunit.util.StringUtils.escapeXmlAttributeValue(value));
            builder_.append('"');
        }
    }
