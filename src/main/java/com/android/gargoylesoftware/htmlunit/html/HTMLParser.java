...
import com.android.gargoylesoftware.htmlunit.svg.SvgElementFactory;
...
import com.android.gargoylesoftware.htmlunit.ObjectInstantiationException;
...
public final class HTMLParser {
    ...
    private static void addBodyToPageIfNecessary(
        ...
        final boolean waitToLoad = page.hasFeature(BrowserVersionFeatures.PAGE_WAIT_LOAD_BEFORE_BODY);
    ...
    static ElementFactory getElementFactory(final HtmlPage page, final String namespaceURI,
        ...
        if (namespaceURI == null || namespaceURI.isEmpty()
            ...
            if (SVG_NAMESPACE.equals(namespaceURI)
                    && page.hasFeature(BrowserVersionFeatures.SVG)) {
                return SVG_FACTORY;
            }
    ...
    static final class HtmlUnitDOMBuilder extends AbstractSAXParser
        ...
        public void startElement(
            ...
            if (parsingInnerHead_ && page_.hasFeature(BrowserVersionFeatures.IGNORE_CONTENTS_OF_INNER_HEAD)) {
                return;
            }
            ...
            if ("body".equals(tagLower)) {
                ...
                if (!page_.hasFeature(BrowserVersionFeatures.JS_DEFINE_GETTER) && page_.isQuirksMode()) {
                ...
                // i like the IE
                if (page_.hasFeature(BrowserVersionFeatures.META_X_UA_COMPATIBLE)) {
        ...
        public void endElement(final String namespaceURI, final String localName, final String qName)
            ...
            if (parsingInnerHead_) {
                ...
                if ("head".equals(tagLower) || page_.hasFeature(BrowserVersionFeatures.IGNORE_CONTENTS_OF_INNER_HEAD)) {
                    return;
                }
            }
        ...
        public void characters(final char[] ch, final int start, final int length) throws SAXException {
            if ((characters_ == null || characters_.length() == 0)
                    && page_.hasFeature(BrowserVersionFeatures.HTMLPARSER_REMOVE_EMPTY_CONTENT)
        ...
        public void comment(final char[] ch, final int start, final int length) {
            ...
            if (!data.startsWith("[CDATA")
                    || !page_.hasFeature(BrowserVersionFeatures.GENERATED_3)) {
        ...
        public void startDTD(final String name, final String publicId, final String systemId) {
            ...
            final Node child;
            if (page_.hasFeature(BrowserVersionFeatures.DOCTYPE_IS_COMMENT)) {
